...
c2 = params(8);
e2 = params(9);
LyapunovExponents = params(10); % Toggle whether system is used for 
...
if LyapunovExponents == 0
    OUT = [udot; vdot; wdot; qdot];
elseif LyapunovExponents == 1
    ...
    error('Lyapunov exponents is not a logical, set params(10) to 1 or 0')
end
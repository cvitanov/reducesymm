...
dimensional $\SOn{2}$-reduced dynamics are chaotic.
    \PC{2014-11-09 Predrag: cite \refref{PoKno05} as another example
    of chaotic parameter values, it they have that}
...
finding the roots of a multinomial expression.\ES{2014-05-15}{Why do you
count complex solutions as equilibria?} First, let we define
\beq
...
\nnu
\eea
We already know that $\invpt{0,0,0,0}$ and $\cartpt{0,-\mu_2/b_2,0,0}$ are roots are the only roots in the
...
break down if we had mode couplings of higher order.}
...
the symmetry reduction, the \reqv\ becomes an \eqv . \refFig{fig:2modes-conf}(c) and \refFig{fig:2modes-conf}(d) show the

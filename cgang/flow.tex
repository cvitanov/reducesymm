...
related to each other by the syzygy \refeq{eq:syzPK}; and thus the flow is confined
on a two dimensional manifold. Hence, we conclude that the \twomode\ system
\refeq{eq:DangSO2} cannot exhibit chaos if the reflection symmetry is restored.

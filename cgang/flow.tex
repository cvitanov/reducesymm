...
model has no physical interpretation, it is the simplest model for the
...
related eachother by the syzygy \refeq{eq:syzPK}; and thus the flow is confined
on a two dimensional manifold. Hence, we conclude that the \twomode\ system
\refeq{eq:DangSO2} can not exhibit chaos if the reflection symmetry is restored.
...
\begin{figure*}%[H]
\centering
(a)\!\!\includegraphics[height=0.22\textwidth]{2modes-conf-reqv}%
(b)\!\!\includegraphics[height=0.22\textwidth]{2modes-confred-reqv}%
(c)\!\!\includegraphics[height=0.22\textwidth]{2modes-conf-rpo}%
(d)\!\!\includegraphics[height=0.22\textwidth]{2modes-confred-rpo}%
(e)\!\!\includegraphics[height=0.22\textwidth]{2modes-conf-ergodic}%
(f)\!\!\includegraphics[height=0.22\textwidth]{2modes-confred-ergodic}%

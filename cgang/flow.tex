...
\statesp this is a \reqv\ and traces out its group orbit. A representative point on this orbit, 
which corresponds to its intersection with first Fourier mode slice, is:
\beq

...
\label{2mode4D}
\eea
By using an appropriate choice of the parameters
$\left(\mu_1,\mu_2,a_1,a_2,b_1,b_2,c_1,c_2,e_1,e_2\right)$, we shall
arrive at a four dimensional model in which the three dimensional
$\SOn{2}$-reduced dynamics are chaotic. While our choice of parameters is
far from the bifurcation values studied by previous authors
\rf{Dang86,AGHO288,JoPro87,PoKno05}, and thus our model has no physical
interpretation, we present it as a useful toy model for the study of
chaotic dynamics in systems with continuous symmetry.
...
The \cartpt{0,0,0,0} \eqv\ eigenvalues are $\lambda_1 = \mu_1$ with multiplicity 2 and
$\lambda_3 = \mu_2 \pm i e_2$. The eigenvectors for $\lambda_1$ are \cartpt{1,0,0,0} and
\cartpt{0,1,0,0} in the \cartpt{x_1,x_2,y_1,y_2} basis. The eigenvectors for $\lambda_2$

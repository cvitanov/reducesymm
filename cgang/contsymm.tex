...
tangent for the velocity vector evaluated at \ssp. \DB{The notation $\groupTan(\vel) = \Lg \vel(\ssp)$ and $\groupTan(\ssp) = \Lg \ssp$ is really cofusing. Is there a particular reason we are using it here?}

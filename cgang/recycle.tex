...
\bea
    ...
    \, &\vdots & \nonumber
\eea
As the integrated observable $\Obser$ can be any observable in a chaotic
flow, not necessarily a spatial displacement, we refer to
...
integrated observable $\Obser$, as the `generalized diffusion constant'.
    \PC{2015-05-03 I have changed Burak's $\Delta_{\Obser}$ to

...
\subsection{Symmetry factorization of the classical trace}
\label{s-ContFac}
...
the drifts in the analogous configuration space. We now define the corresponding
diffusion constant proportional to the variance of the phase (drift) velocity
\beq

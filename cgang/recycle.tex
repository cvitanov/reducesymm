...
by recaptulating the presentation of \refref{DasBuch}, but then, in
...
\subsection{Irreducible representations decomposition of the trace formula}
\label{s-ContFac}
...
this substitution in \cycForm s since, in practice, our approximation to

...
%%%%%%%%%%%%%%% EXPERIMENTAL, 2modes.tex %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\newcommand{\Mvar}{\ensuremath{\mathbb{A}}}  % stability matrix
\newcommand{\jMps}{\ensuremath{\mathbb{J}}}   % jacobian matrix, phase space/state space
\newcommand{\monodromy}{\ensuremath{\mathbb{M}}}   % monodromy matrix, full Poincare cut
\newcommand{\Lg}{\ensuremath{\mathbb{T}}}   % Predrag Lie algebra generator
% \newcommand{\Lg}{\ensuremath{\mathbf{T}}}   % Predrag Lie algebra generator
\newcommand{\matrixRep}{\ensuremath{\mathbb{D}}}  %  matrix rep of a group element
\newcommand{\LieEl}{\ensuremath{g}}  %  a group element (often replace by \LieRep

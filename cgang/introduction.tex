...
to handle self-similar solutions.}
\ES{2014-05-27}{Dropped this: the reconstruction equations
developed in \refref{rowley_reconstruction_2000} and formulated them using a `rescaled
time' variable.
} 
Beyn and Th\"{u}mmler\rf{BeTh04} applied the \mslices\ to `freeze' spiral
waves in reaction-diffusion systems.
\ESedit{
While these studies applied the method to a single solution at a time,
nonlinear dynamics studies of extended systems require symmetry reduction 
...
Froehlich and Cvitanovi\'{c}\rf{FrCv11}.
\ESedit{
...
by Cvitanovi\'{c} \etal~\rf{atlas12} and to pipe flow by Willis, Cvitanovi\'{c}, and Avila\rf{ACHKW11}. 
A

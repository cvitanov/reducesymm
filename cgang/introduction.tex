...
of \rpo s and \reqva ? It seems to me that this statement isn't necessarily true right?} in 
...
method used to calculate the \rpo s\DB{9/16/2014}{Replaced cycles with \rpo s. This IS what we are refering to right?}. 

...
in \refref{rowley_reconstruction_2000} and formulated them using a `rescaled
...
\refRefs{SiCvi10,FrCv11} used the \mslices\ to quotient the \SOn{2} symmetry of
...
\refref{FrCv11} and a solution using multiple `charts' of connected
slices was proposed. This approach was applied to \cLf\
in \refref{atlas12} and to pipe flow in \refref{ACHKW11}. A

...
\begin{align}
  \dot{z}_1 &= (\mu_1\ESedit{-\ii\, e_1})\,z_1+a_1\,z_1|z_1|^2+b_1\,z_1|z_2|^2+c_1\,\overline{z}_1\,z_2\,\\
		...
		\begin{itemize}
			...
			\bea
				\dot{x}_1 &=& \mu_1 x_1 + a_1 x_1^3 + b_1 x_1 y_1^2 + c_1 x_1 y_1 + a_1 x_1 x_2^2 + b_1 x_1 y_2^2
                              + c_1 x_2 y_2
				\continue
				\dot{x}_1 &=& \mu_1 x_2 + a_1 x_1^2 x_2 + c_1 x_1 y_2 + b_1 y_1^2 x_2 - c_1 y_1 x_2 + a_1 x_2^3
                         + b_1 x_2 y_2^2
				\continue
			...
			\item(b) Now, show that the stability matrix
({\color{red}insert DasBuch eq. ref here, originally eq. 4.3}) A for this 				
system is given by

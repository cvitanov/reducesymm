...
be chaotic. We shall refer to \refeq{eq:DangSO2} as the {\twoMode}
system. Substituting \refeq{eq:DangSO2} into \refeq{PKinvEqs} we obtain a
set of 4 equations,
    \PC{2012-04-27 to Lei and all, please recheck! $e_2$ terms differ from Lei. DB 04-29: Double checked using computer algebra. Found a couple of discrepancies. Fixed them in red.}
\bea
  \dot{u} &=& 2\,\mu_1\,u+2\,a_1\,u^2+2\,b_1\,u\,v\ESedit{^2}+c_1\,w %Double checked DB 04-29-2012 % Triple checked ES 04-30-2012, corrected b_1 term. DB:I don't see how you get enough v's to get a v^2. There's only one in z1dot and there are none in z1. Also remembere that w's and q's have a 2*u*(v^.5) out front. Maybe you forgot the sqrt? Anyway, don't have Mathematica at home so I'll double check when I get to Tech.
\continue
  \dot{v} &=& 2\,\mu_2\,v+2\,a_2\,u\,v+2\,b_2\,v^2+c_2\,w %Double checked DB 04-29-2012 % Triple checked ES 04-30-2012
\continue
  \dot{w} &=& (2\,\mu_1+\mu_2)\,w +\ESedit{2a_1\,w\,u^2+ a_2\,w\,v^2+2b_1\,w\,v^2 + b_2\,w\,v} %Double checked DB 04-29-2012 corrected coefficients for uv and u^2 terms % Triple checked ES 04-30-2012, corrected a_1, a_2, b_1 terms.
\ceq
             +\, \DBedit{4}c_1\,u\,v + \DBedit{2}c_2\,u^2 - e_2\,q
\label{PKinvEqs1}\\
  \dot{q} &=& (2\mu_1+\mu_2)\,q+ \ESedit{2a_1\,q\,u^2+a_2\,q\,v^2}
\ceq
			  \ESedit{+2b_1\,q\,v^2+b_2\,v\,q}
             +e_2\,w %Double checked DB 04-29-2012 % Triple checked ES 04-30-2012, corrected a_1, a_2, b_1 terms.
\nnu
\eea
...
basis \refeq{eq:DangSO2} in terms of these invariant polynomials.

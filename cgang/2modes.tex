...
\begin{itemize}
  ...
  \item[10.11] Visualizations of the 4-dimensional 2-mode system
  \item[10.1?] draw a group orbit for the 2-mode model
  ...
  \item[10.2?] construct a 2-chart atlas for a 2-mode system
\end{itemize}

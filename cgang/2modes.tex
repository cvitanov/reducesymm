...
in understanding the dynamics. {\Mslices} is a technique for reducing
...
the group action. We demonstrate the {\mslices} by applying it to
...
in the \SOn{2}-equivariant {\statesp}, in the polar coordinates, and
...
parameters and apply the {\mslices} on these systems. We show
...
no longer useful. The set of points within a \slicePlane\ which satisfies
\beq

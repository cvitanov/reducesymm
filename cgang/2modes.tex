...
%[2012-04-28 Predrag]
How to solve for \eqva\ of \refeq{PKinvEqs1}? Define
\beq
...
\bea
	f(u,v) &=& c_2\,u\,A_1 - c_1\,v\,A_2 = 0 \,,\qquad  deg(f) = 2
	\continue
	g(u,v) &=&
 \left(4\,A_1^2 u^2 - 4\,c_1^2\,u^2 v\right)\left(c_2\,u+2\,c_1\,v\right)^2 %Double checked DB 04-30-2012
	\ceq
...
so, eliminate one of the roots at the origin and $[0,-\mu_2/b_2,0,0]$ root from
the solutions. Furthermore, scale the parameters and variables as
$\tilde{u} = c_2\,u$,
$\tilde{v} = c_1\,v$,
$\tilde{a_1} = a_1/c_2$,
$\tilde{b_1} = b_1/c_1$,
...
the second one to solve for single variable.
\begin{table}
...
\twoMode\ system equations can be written as: 
\bea
...
\bea
	...
	(u,v,w,q) &=& (0,0,0,0) \qquad \mbox{(double)}
			  \continue
			  &=& (0.19357,0.154131,-0.149539,-0.016076)
			  \continue
			  &=& (0,- \infty,0,0)
			  \continue
			  &=& (-2.8,0,0,0)
			  \continue
			  &=& (-5.52172,0.12361,-3.87834,0.223778)
			  \continue
...
Starting close to the relative equilibrium $x_0 = (-0.31056, -0.31056, -0.04191, -0.38981)$
...
for \refeq{eq:firstmodetemplate} and \refeq{LGTwoMode}) and projected the resulting
...
condition $x_0 = (-0.31056, -0.31056, -0.04191, -0.38981)$ close to the relative

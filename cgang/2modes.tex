...
\beq
\left(\frac{w}{\DBedit{2}}\right)^2+\left(\frac{q}{\DBedit{2}}\right)^2 - u^2v =0 %DB 04-29-2012 added factors of 2 for w and q terms 
  \,,
\label{eq:syzPK}
\eeq
...
set of 4 equations,
    \PC{2012-04-27 to Lei and all, please recheck! $e_2$ terms differ from Lei}
\bea
...
\ceq
             +2\,c_1\,u\,v + \PCedit{c_2\,u^2 - e_2\,q}
\label{PKinvEqs1}\\

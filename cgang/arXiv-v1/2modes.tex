...
since $J_i$ and $g_i$\DB{2014-11-11}{Should this be $g$ or $D$?} commute with 
each other, and are multiplicative respectively in time and phase. In order to 
determine the eigenvalues of $\hat{\jMps}$, we bring each term appearing in 
the product \refeq{e-JacobianProduct} into periodic, real Schur form as 
follows:
\beq

...
%    }
In our first attempt to understand the dynamics of the flow, we examine its stability by finding the \stabmat\ $\Mvar$. This is the matrix of partial derivatives of $v(x)$,
\beq

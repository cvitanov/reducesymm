...
as in \reffig{fig:Tesselate}. Any neighboring pair of pair of slices intersects in a
`ridge,' a
...
The intersection of two $(d\!-\!1)$\dmn\ hyperplanes \refeq{PCsectQ0} is
...
It should be emphasized that such atlas retains the dimensionality of

...
the transformation parameters $\gSpace$ for which the state $\ssp$ is
...
\,.
\ee{PCsectQ0}
The group orbit points closest to the template thus lie in a
$(d\!-\!N)$\dmn\ hyperplane, the set of vectors $\sspRed \in  \pSRed$
orthogonal to the group tangent space spanned by tangent vectors

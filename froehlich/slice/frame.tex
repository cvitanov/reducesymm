...
The other thing that should be emphasized is that a {\template} is not
...
\refeq{eq:so2sing} as a polynomial equation, with coefficients determined
...
the distance function \refeq{PCsectQ}. For example, group orbits of
...
minimum or the \emph{infimum} of \refeq{minDistance0}. It does not matter

...
% Stefan edits, from siminos/inputs/defsFroehlich.tex
...
\newcommand{\sspSing}{\ensuremath{\ssp^*}} 	% singular point
\newcommand{\sspRSing}{\ensuremath{\sspRed^*}} 	% singular point, reduced space

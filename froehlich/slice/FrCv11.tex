...
%\papertrue\boyscoutfalse 		% article for submission
								% use \documentclass[preprint,12pt]
...
\input ./defsFrCv11            %% descended from dasbuch/book/inputs/def.tex
...
\bibliographystyle{./Elsevier/elsarticle-num}  %default style
% \bibliographystyle{model3-num-names}		% gave error after 25 or so refs.

...
\item[2010-07-15 SF]
You are right, it is $T_{ij}$ and not $I_{ij}$. I apparently messed up when writing it up because I use the correct formula when doing the programs to find the stability matrix in reduced space.

...
Stefan, write the caption
 ...
 \caption{\label{fig:RedTrajNoPlane2}
Probably the best, as it shows the semicircle that you then
blow up in \reffig{fig:singpass1}. Stefan, write the caption
 }%
 \end{figure}
...
Stefan, write the caption
 ...
 \caption{\label{fig:RedTrajPlane2}
Stefan, write the caption
 }%
 \end{figure}
 ...
 \caption{\label{fig:RedTrajPlane3}
...
Stefan, write the caption.
Current singpass1.png has a large white edge - clip it.
 }%
 \end{figure}
...
\item[2010-12-23 PC to Stefan] re the above batch of *.png figures -
they all need the white borders trimmed, so figure fills the entire frame
in both higth and width.

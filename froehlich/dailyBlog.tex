...
\item[2010-07-06 SF]
I added three programs for approximating the Jacobian along any trajectory. They all give slightly different answers so I'm not sure yet just how accurate they are.

\item[2010-07-09 SF]
I checked how close each of the approximations were to satisfying $v\left(x\right)=J^t\left(x_0\right) v\left(x_0\right)$ and the Jacobian.m program, where I use the system of differential equations, is by far the most accurate.

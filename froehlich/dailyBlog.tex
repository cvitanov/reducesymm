...
\item[2010-06-18 SF]
I calculated the stability matrix for the flow when restricted to a hyperplane by using infinitesimal rotations and got that $M_{ij} = A_{ij}-c I_{ij} -(Tx)_i\,(\frac{\frac{\partial v}{\partial x_i}\cdot t'}{Tx \cdot t'} - c \frac{\frac{\partial (Tx)}{\partial x_j}\cdot t'}{Tx \cdot t'})$ where c is the angular velocity of the relative equilibrium, t' is a vector normal to the plane, and wherever there is a $\cdot$ it means dot product.

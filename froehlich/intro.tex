...
Locally any point is rotatable into a linear slice, and \refref{rowley_reconstruction_2000,rowley_reduction_2003} demonstrate that this is true globally for certain {\statesp}s. This paper provides a more general proof that is applicable to more {\statesp}s than that of \refref{rowley_reconstruction_2000,rowley_reduction_2003}.

...
Orbit Theory' I had to reread Zoldi and Kazantsev. It's like having to
...
unfortunately we have to address it in print, because it keeps getting
...
publication?). Here are some preparatory notes.
...
simplicity.
% Let's say you are a graduate student, without an adviser
% versed in nonlinear dynamics.
If you have a dynamical problem, and if you have a computer you have
trained to troll for \po s, and if the computer brings back a set of
unstable \po s, all you have to do is put $\Lyap_{p,j}$ and $\obser_p$
into the formula \refeq{ZoldiAv}, and it returns a number - let's say $D
= 9.0 \pm 0.1$, where the error you had sitting in your fridge - which
you then publish.
...
initial point on the \po\ $p$. (3) $\sum_p$ is the sum over {\em all}
unstable prime \po s, regardless whether they belong to the ergodic component
...
formulas: \po s hierarchically ordered, their Floquet multipliers,
...
[{\bf 2004-09-20 Predrag}: Its subtle. Depending on the observable,
marginal cycles might lead to power laws, or might not matter at all.
That's why we have a theory of phase transitions\rf{ACK89}.]
...
[{\bf 2004-09-20 Predrag}: Stability ordering helps\rf{DM97,carl97int}]
Even if a system is
...
[{\bf 2004-09-20 Predrag}: Tough luck. Nobody promised you a rose
garden.]
...
accurately. [{\bf 2004-09-20 Predrag}: Really?]
...
[{\bf 2012-09-20 Predrag:} what the ??? Why?] We impose the
...
[{\bf 2012-09-18 Predrag:} Incorporating unstable \eqva\ is not crazy, as
...
published in Phys. Rev. Letters (where were faculty advisers?), but
...
\item[Sept. 2003 Predrag] I've never gotten research funding in US for
work on periodic orbit theory. Here is why
\HREF{http://www.cns.gatech.edu/~predrag/research.html} {an NSF
evaluation} from `anonymous' reviewer (italics are mine). Go figure...
...
are not available. Periodic orbits \emph{are interesting only when they can be
computed from time series}, typically under noise. Works and partial
success in the past demonstrate how difficult this task can be. There is
no mentioning of this important issue in the proposal. \emph{It is difficult to
see how the proposed research could be of interest even to a researcher
in nonlinear dynamics, let alone people from other disciplines.}

\emph{The narrow scope and the possible lack of appeals of the proposal even to
researchers indicate that it may be difficult to attract talented
...
\noindent
%Predrag 2009-12-01
I derived `cycle expansions' in 1986. They arose not from dynamics, but
from a study of the scalings in period-doubling
renormalization\rf{CCR,AACII,CGV}. I then applied the same technique to
study of the topology of the H\'enon attractor, and developed my pruning
front theory\rf{pre88top}. This work was done at Chalmers, Gothenburg
1985-1986 and at Cornell January-May 1985.

I do not publish until we understand a topic in depth (cycle expansions
...
here?}'', a meeting organized by Itamar Procaccia and
held December 13--19, 1986 at Kiryat Anavim kibbutz in Israel. A great
meeting, and Celso Grebogi was in the audience.

Grebogi never cites me or Kiryat Anavim or cycle expansions. A number
of people do have proceedings papers listed in their CVs as published in
Proc. Fritz Haber Int. Symposium ``Chaos and Related Nonlinear Phenomena:
Where do we go from here?'' Kiryat Anavim, December 13--19, 1986, edited
by I. Procaccia (Plenum, New York, 1987). That's funny, as no proceedings
were ever published.

The first published paper was Auerbach \etal\rf{pchaot} (submitted 13
March 1987). We had agreed that Procaccia would not show me the
manuscript before the paper was published, as I surely would have gone
through the roof had I read it (my collaborators did not understand cycle
expansions, so only a `level sum' approximation to the trace formula is
...
better. It did not do much good.
...
have been written down for the first time. Ever since the Maryland school
cites only Maryland papers and some of the mathematicians of the 1970's,
never the Copenhagen papers. Maryland group is extraordinarily fond of
...
Goldobin\rf{ZakGol10}. It would not hurt to recycle these kinds of
computations in terms of spectral determinants, instead of sticking to
evaluations of approximate trace formulas. There is no extra work
involved, except reading relevant bits of ChaosBook and/or Gaspard
monograph\rf{PG97}, and inserting the same set of UPOs of the Lorenz
equations into cycle expansions. They should converge faster - symbolic
dynamics is a problem here, so perhaps one would need to use the
stability cutoffs.
...
So much meaningless busyness, and so little time to try to understand the
original and better formulation.

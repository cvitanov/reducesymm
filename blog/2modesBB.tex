...
\begin{figure}%[ht]
  ...
  \end{center}
  \caption{
	Poincar\'e section plane which includes the origin and is perpendicular 
	to the normal vector given in \refeq{eq:nhat0GS}
    }
  \label{fig:BBPKpsect0}
\end{figure}
Poincare section plane \reffig{fig:BBPKpsect1} including the \reqv\ is 
perpendicular to 
\beq
	\hat{n}_{1,GS} = (0.965496, 0.073005, 0.249976)
	\label{eq:nhat1GS}
\eeq
\begin{figure}%[ht]
  \begin{center}
  ...
  \end{center}
  \caption{
	Poincar\'e section plane which includes the relative equilibrium and 

...
\item[2014-05-22 Daniel to Gang] Started double checking equations in \refsec{s:twoMode} using computer algebra and assuming that we are sticking with $z_k = x_k + y_k$ notation. So far I have done \refeq{2mode4D}, \refeq{eq:syzPK},

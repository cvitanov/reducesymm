...
The main reason I am asking is that, if I understand people correctly, it is not straightforward to compute
...
\item[2014-06-24] The alternative approach is to find as many cycles as possible,
...
theory. The reason that we cannot average over the ``phase velocities of 
...
figures \reffig{fig:psectandretmap} and \reffig{fig:Set1}, I'll start writing

...
\item[2013-11-05 Burak] I implemented in {\mconn} by integrating \refeq{transvFlow}
for O(2)-equivariant case and plotted trajectories for a \rpo\ in \reffig{fig:BBO2RpoSspComovSlice}.

\begin{figure}[H]
\centering
 (a) \includegraphics[width=0.3\textwidth]{BBO2a1045rpossp}
 (b) \includegraphics[width=0.3\textwidth]{BBO2a1045rpocomov}
 (c) \includegraphics[width=0.3\textwidth]{BBO2a1045rposlice}
\caption{(a) A \rpo\ in the symmetry equivariant \statesp . 
(b) Same trajectory computed in the co-moving frame (c)  Same trajectory on
the slice hyperplane.

...
\refeq{eq:ssp2invpolwithinslice} was infact not a solution, but a minimum and 
...
This, I think, is interesting, but it also prooves that my previous Jacobian calculations in
[2013-09-28 Burak] was not quite accurate. If I compute the Jacobian as if this
...
it runs standalone without a problem on my Ubuntu 12.04-64bit, and then load
the state file
...
equivariant and sliced flow on top of eachother. I'm not sure if this may be 
helpful in explaining \mslices , but I think it's beautiful, so I'm blogging it.
...
\caption{Symmetry equivariant flow and its projection to the magic slice.}

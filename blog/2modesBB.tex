...
cannot exhibit chaos. I also checked variation of x with time and saw reccurence
...
\SFIG{BBO2psectgsa1eq0475}{}{
 A \rpo\ with a very long period ($T \approx 472$) on the
 Poincar\'e section in the reduced \statesp .
...
\item[2013-10-28 Burak] In the original Porter-Knobloch paper (\refref{PoKno05})
Figure 5 shows a chaotic flow with an attractor topology very similar to what
...
have the most general 2-mode system here. I'll work on this correspondance in
more detail.
...
\bea
	...
	\label{eq:C2toR4}
\eea
While this is similar to the mapping that you used for the Complex Lorenz system,

...
the invariant polynomials basis''?)} \BBedit{(\bf [2013-08-25 Burak] Yes.)}
...
\item[2013-08-25 Burak] I am sending Kim the invitation to the Google updates group and the quick start guide (for Debian-based Linux Distros. I am also blogging it in \texttt{strategy.tex}) you can give her collaborator access once she gets herself a gitHub account.   

\item[2013-08-25 Burak] Using the parameters in \refeq{eq:PKDanielParsVaried} I scanned the invariant coordinates $u$ and $v$ from 0 to 1000 (increasing each by steps of 10) and looked for a \eqv starting a Newton - Raphson search from each $(u,v)$ combination. Code is here: \texttt{/blog/burak/PorterKnobloch/rootfinding/pkroots.m}. The \eqva\ that I found are
\bea
(u,v,w,q) &=& (0,0,0,0)
    \continue
...
\bea
\lambda_i &=& (-5.60460,1.22560,-4.99180 \pm 2.17690i)
    \continue
		   &=& (-11.62009,0.02993 \pm 1.97539i, -5.82124)
	\continue
		   &=& (-318.12740, 7.99278, -10.73945, -159.45337)
	\continue
		   &=& (-318.65092,2.74751,-3.87388,-159.32547)
	\continue
		   &=& (-318.34481,6.44915,-8.52430,-159.40058)
	\continue
		   &=& (-318.71575,-159.30945,0.69456,-1.61956)
	\continue
		   &=& (-317.69045,10.22285,-14.31342,-159.55807)
\,.
\label{eq:PKDanielParsVariedEqvaEvals}
\eea 
Each found \eqv\ has at least one positive eigenvalue.

\item[2013-08-25 Burak] I also computed the dynamics within the reduced space and generated exact same trajectory that I got from the direct integration in the full \statesp using the parameters in \refeq{eq:PKDanielParsVaried}. You can reproduce this result by following the directions in [2013-08-23 Burak].

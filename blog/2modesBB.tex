...
\input{../blog/2modesDynamicalAverages}

\input{../blog/2modesDynamicalAveragesNoGrammar}
...
(finite grammar) in order upto $5$ in the expansion:
\bea
	\zeta (0, 0) &=& 0.326019994263891, -0.173842965806291, 0.126663646598951, \continue
...
N=1, thanks. (by the way, shouldn't it be $\zeta(0,0)^{-1}$ above?)

...
is obtained by solving
    ...
    If I am right, the rest of Burak's draft is wrong. \BBedit{2014-02-03 I agree. THANK YOU.}}
...
\ee{RPOmultishootConstraints}
Imposing these local conditions is natural \BBedit{(2014-02-03 I think choosing
...
in the limit of infinitely many infinitesimal time steps, the \rpo\ that 
they yield is the so-called `comoving \rpo'. A globally imposed fixed
...
a particular norm in \refeq{RPOmultishootConstraints}; that is very
...
\item[2014-02-03 Burak] After adding the missing term, mutlishoot \rpo\ 
searches started to become successful. Here are 
four \rpo s in the \slice\ hyperplane: \refFig{fig:2modeRPOs}.

\begin{figure}%[H]
\centering
 (a) \includegraphics[width=0.3\textwidth]{BBPK01}
 (b) \includegraphics[width=0.3\textwidth]{BBPK01101}
 \\
 (c) \includegraphics[width=0.3\textwidth]{BBPK011101}
 (d) \includegraphics[width=0.3\textwidth]{BBPK011111}
\caption{
(a) \Rpo\ \cycle{01} plotted in the \slice\ hyperplane.
(b) \Rpo\ \cycle{01101} plotted in the \slice\ hyperplane.
(c) \Rpo\ \cycle{011101} plotted in the \slice\ hyperplane.
(d) \Rpo\ \cycle{011111} plotted in the \slice\ hyperplane.
}
\label{fig:2modeRPOs}
\end{figure}

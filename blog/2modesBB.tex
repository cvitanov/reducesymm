...
\item[2014-05-26 Daniel] At Burak's request I have used my Lyaupnov exponent code based on Wolf et al. \cite{WolfSwift85} to calculate the leading Lyapunov exponent for the \twomode\ system with $\mu_1 = -2.8, \mu_2 = 1, a_1 = -1, a_2 = -2.66, b_1 = 0, b_2 = 0, c_1 = -7.75, c_2 = 1, e_1 = 0, \,\mathrm{and}\, e_2 = 1$. I did my calculation in invariant polynomial coordinates. Since this method requires an initial conditions to start the calculation, I started with 16 different initial conditions in the range $u,v \in [0,3]$ and $\psi \in [0 \pi]$. I got a mean value of $\lambda_1 = 0.1174$ with standard error of $\pm .0023$ (95\% confidence level), which seems to agree quite nicely with Burak's calculation of 0.118268 from cycle expansions. I'll run some more trials later tonight and report back with better statistics.

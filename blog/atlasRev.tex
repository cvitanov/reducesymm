...
\DBedit{AIP COMMENT: Please provide the definition for “PDE.”
...
(line 41) space s -> spaces DB 10-08-2012
(line 115) space s -> spaces DB 10-08-2012
(line 245) by Siminos^{,17} -> in Ref. 17 DB 10-08-2012
(line 301) solutions -> solution DB 10-08-2012
(line 396) z=-b z -> \dot{z}=-bz DB 10-08-2012
(line 427) Eq. (1) -> (1) DB 10-08-2012
(line 485) prime should be superscripted DB 10-08-2012
(line 525) space s -> spaces DB 10-08-2012
(caption of Fig. 6, second line) primes should be  superscripted DB 10-08-2012

\item[2012-10-06 Daniel]\\
\DBedit{(7) Lines 3-5: Should Evangelos's current affiliation with MPI be noted in the author list or is CNS ok?}\\
\ESedit{I've added MPI as second affiliation. If it is not a moral thing to do Predrag please remove.}
...
(19) Line 246: ``$\sigma = 10, e = 1/10.$'' should be ``$\sigma = 10$, and $e = 1/10.$'' DB 10-08-2012\\
...
\ESedit{I had to really look closely in order to see the difference. I think it's OK}\\
(24) Figure 6 caption: The primes are not supercripted in ``$t'_1...t'_N$'' DB 10-08-2012\\
...
\ESedit{Probably that was the best they could do, let it be.}\\
...
\DBedit{(32) Line 471: Replace ``slices transversally a group orbit'' with ``slices a group orbit transversally''. Hmmm actually... is tranversally even a word. Should it be transversely?}\\
\ESedit{It should be transversely.}
...
\item[2012-10-08 Daniel] Marked up proof and uploaded it to Dropbox. There are a couple of issues that are still open which I left as red DBedit's in the entries above. I am not totally sure what to do with them. Could somebody take a look and fix these?

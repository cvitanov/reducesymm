...
(7) Lines 3-5: Should Evangelos's current affiliation with MPI be noted in the author list or is CNS ok?\\
(8) Line 34: Missing Oxford comma (that's what we use throughout). Should be ``...equilibriaCOMMA and infinite hierarchies...''\\
(9) Lines 41, 115, and 525: ``state spaces'' macro rendered as ``state space s''. Needs to be fixed.\\
(10) Lines 75 and 366: We are using $\tau$ for time. $f^t(x)$ should be $f^\tau (x)$.\\
(11) Lines 367: Again $t$ should be $\tau$. $\hat{f}^t$ is kind of rendered weird, almost like the $t$ is a superscript of the hat.\\
(12) Line 95: ``...and thus are...'' should be ``...and, thus, are...''. Add commas.\\
(13) Line 97: ``...turbulence, and capture...'' should be ``...turbulence and capture...''. Remove comma\\
(14) Line 104: ``...the only, or the most natural...'' should be ``...the only or the most natural...'' Remove comma.\\
(15) Caption for Figure 1: ``...flow $x(\tau)$, and the N group...'' should be ``...flow $x(\tau)$ and the N group...'', no comma.\\
(16) Line 125: ``revisited'' should be ``visited''.\\
(17) Line 127: ``sections, with'' should be ``sections with''. No comma.\\
(18) Line 245: ``Siminos’^{17}'' should be ``Siminos,^{17}'' comma instead of apostrophe.\\
(19) Line 246: ``$\sigma = 10, e = 1/10.$'' should be ``$\sigma = 10$, and $e = 1/10.$''\\
(20) Line 254: Oxford comma missing ``...symbolic dynamics and in-depth...'' should be ``...symbolic dynamics, and in-depth...''\\
(21) Line 266: Might be improved by changing ``the group orbit'' to ``its own group orbit''\\
(22) Line 276: Remove comma after ``pose''\\
(23) Lines 337, 342, 346, 364, 387, Figure 7 caption, 413, 439, 442, Figure 10 caption, 448, 494, and 508: $t'$ looks weird like the t and the prime are not spaced correctly (as in for example in Fig. 5d).\\
(24) Figure 6 caption: The primes are not supercripted in ``$t'_1...t'_N$''\\
(25) Figure 9 caption: There is no room between the primes and the parenthesis in $\hat{x}'^(n)$. It looks funny. Should be like in the figure.\\
(26) Lines 404-407: The line spacing in this paragraph is weird. Seems like the superscripts are way too high and you get a bunch of white space between lines.\\
(27) Line 416: Remove extra parenthesis after ``Fig. 10(a)''\\
(28)THROUGHOUT: The hat over the script M for the reduced state space or charts is not centered over the M as it would be if you layed it out in LaTex\\
(29) Line 425: Replace the awkward ``but this seems not possible'' with ``but this does not seem possible''\\
(30) Line 426: Replace ``hydrodynamics turbulence'' with ``hydrodynamic turbulence''. No s.\\
(31) Figure 11 caption: primes after $x$s are not superscripted.\\
(32) Line 471: Replace ``slices transversally a group orbit'' with ``slices a group orbit transversally''\\
(33) Lines 483-491: Line spacing is weird when there are superscripts in this paragraph.\\
(34) Line 485: prime after $x$ is not superscripted.\\
(35) Lines 508 and 511: The prime on $\hat{t}$ is superscripted on the instead of $\hat{t}$\\
(36) Lines 533-534: Don't split the number $60,000$ between lines.\\
(37) Line 555: Replace ``flow, there'' with ``flow. There''\\

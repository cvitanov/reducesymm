...
don't want to symmetry reduce within invariant subspaces? [ES correcting himself
a few minutes later: I'm not the only one, Predrag is also worried. This
blog is getting very hard to read.]

\item[2012-04-28 Predrag]
Have a really important paper to write, but doing algebra by hand is so much easier:
how to solve for \eqva\ of \refeq{PKinvEqs}? Can rewrite it as
\bea
  0  &=& (2\,\mu_1+2\,a_1\,u+2\,b_1\,v)\,u +c_1\,w
\continue
  0  &=& (2\,\mu_2+2\,a_2\,u+2\,b_2\,v)\,v+c_2\,w
\continue
...
\eea
Already
know $[0,0,0,0]$ and $[0,v,0,0]$ roots, so we are looking only for the
$u>0$, $v>0$, $w,q \in \reals$ solutions; there could be problems from the
non-generic roots with either $w=0$ or $q=0$ (but not both simultaneously,
syzygy \refeq{eq:syzPK} precludes that). $w$ and/or $q$ can be easily eliminated,
\bea
  w  &=& - \frac{u}{c_1}(2\,\mu_1+2\,a_1\,u+2\,b_1\,v)
\continue
  w  &=& - \frac{v}{c_2}(2\,\mu_2+2\,a_2\,u+2\,b_2\,v)
\continue
   2\,e_2\,q  &=& A\,w   +2\,c_1\,u\,v +2\,c_2\,u^2
\label{PKinvEqs4}\\
  w  &=& -\frac{2\,q}{e_2} A
\continue
    A &=& 2\,\mu_1+\mu_2+(2a_1+a_2)\,u+(2b_1+b_2)\,v
\nnu
\eea
then we obtain a  (bivariate)  polynomial in two variables with constant coefficients
\bea
  \frac{v}{c_2}(2\,\mu_2+2\,a_2\,u+2\,b_2\,v)  &=& \frac{u}{c_1}(2\,\mu_1+2\,a_1\,u+2\,b_1\,v)
\continue
  \frac{2}{e_2^2} A \, (A\,w   +2\,c_1\,u\,v +2\,c_2\,u^2)
     &=& \frac{u}{c_1}(2\,\mu_1+2\,a_1\,u+2\,b_1\,v) + \frac{v}{c_2}(2\,\mu_2+2\,a_2\,u+2\,b_2\,v)
\continue
  A &=& 2\,\mu_1+\mu_2+(2a_1+a_2)\,u+(2b_1+b_2)\,v
\,,
\label{PKinvEqs5}
\eea
an equation not as simple as \refeq{2modefixdenom}, not sure why.

Finding roots of bivariate polynomials is not easy.

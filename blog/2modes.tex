...
\item[2012-04-30 Daniel] Using \refeq{PKinvEqs7}, basically yields eq.
\refeq{2modeSinCond} written in $u$'s and $v$'s. Using the equations for
...
Substitute $\ssp=\LieEl\sspRed$.
    ...
    \Lg = \LieEl \Lg$, but we have to redo it more carefully for nonabelian

...
\item[2012-08-01 Daniel] If what Predrag says is true and the traces should be
the equivalent independent of whether we use equivariant coordinates or invariant
coordinates, then I have either made a mistake in calculating one or the other. It is kind of worrisome that these do not agree for the stability of the origin. I've double checked my calculation, but I don't see anything wrong with it. Is it possible that they
are not the same and that their difference (or something like that) lets us extract a
multiplier or something. Or maybe equating the two gives some kind of information. I just don't see what I did wrong in my computation.

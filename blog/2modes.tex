...
Daniel] above: Have you really changed to $z_1 = x_1 + \ii x_2$
and $z_2 = y_1 + \ii y_2$? Left-hand-side of \refeq{2mode4D} and
\refeq{2mode4Da} looks like the old version; $\mu_i$ factors do not match
up. Please recheck. [2012-06-11 Daniel] Somehow missed this request. Double-checked them and it turns out that I forgot to update the left-hand sides of \refeq{2mode4D} and \refeq{2mode4Da}. I have now corrected them. For details of the derivation see \texttt{/siminos/cgang/Daniel/Matlab/EOMComplexTo4.m}.

...
\item[2012-04-28 Daniel] Well, it's sort of trivially easy fix. I just thought I'd keep 1's together and 2's together since that's the way they appear in eqs. \refeq{eq:AGpolar} and \refeq{eq:DangSO2}. Want me to change them to $z_1 = x_1 + x_2$ and $z_2 = y_1 + y_2$? I would take me 5 minutes. 
...
\label{Dang86(1.2)PK}
\eea
where in polar coordinates $ {z}_1 = |u|^{1/2} e^{\DBedit{i}\theta_1}$, $ {z}_2 =
|v|^{1/2} e^{\DBedit{i}\theta_2}$, and the relative angle in the $w$ invariant is
...
\item[2012-04-28 Lei] rechecked equation
\refeq{PKinvEqs1}, and got
\bea
  \dot{u} &=& 2\,\mu_1\,u+2\,a_1\,u^2+2\,b_1\,u\,v+c_1\,w
\continue
  \dot{v} &=& 2\,\mu_2\,u+2\,a_2\,u\,v+2\,b_2\,v^2+c_2\,w
...
\item[2012-04-28 Evangelos] Indeed, using \refeq{PKinvEqs2} should be the 
...
one would have to solve $\dot{u}=\dot{v}=\dot{w}=\dot{q}=0$ in \refeq{PKinvEqs2}
together with the syzygy \refeq{eq:syzPK} [$w^2+q^2 - u^2v =0$], right? 
...
\caption{
(a) Symmetry reduced trajectory, side perspective.

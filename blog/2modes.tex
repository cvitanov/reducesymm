...
\item[2012-07-31 Evangelos] Using the syzygy $w^2+q^2-4u^2v=0$ we can
...
\label{PKinvEqs1syz}
\eea
Now compute the {\stabmat} from \refeq{PKinvEqs1syz}:
\footnotesize
\beq
\Mvar  \, =
\left( \begin{array}{lll}
	...
	4 c_2 u+4 c_1 v+(2 a_1+a_2) w+\frac{4 (2 e_1-e_2) u v}{\sqrt{4 u^2 v-w^2}} & 4 c_1 u+(2 b_1+b_2) w+\frac{2 (2 e_1-e_2) u^2}{\sqrt{4 u^2 v-w^2}} & 2 \mu_1+\mu_2+(2 a_1+a_2) u+(2 b_1+b_2) v-\frac{(2 e_1-e_2) w}{\sqrt{4 u^2 v-w^2}}
      \end{array} \right)
\,.

...
There is theorem due to Pascal Chossat that in systems of hydrodynamic
type ($2D$ Navier-Stokes) close to this codimension 2 bifurcation
$c_1c_2<0$. This is also the case for which one gets structurally stable
heteroclinic cycles if symmetry is \On{2}\ (\ie, when $e_1=e_2=0$).
...
polynomial equations such as \refeq{PKinvEqs5a}. For an example see

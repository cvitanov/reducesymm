...
\continue
  0  &=& (2\,A_1+ A_2)\,w
             +\PCedit{2\,}\left(c_2\,u+2\,c_1\,v\right)\,u -e_2\,q
\label{PKinvEqs3}\\
  0  &=& (2\,A_1+ A_2)\,q + e_2\,\,w
\nnu
\eea
...
\DBedit{DB: Not sure where this factor of 2 comes from in $w = -\frac{2}{e_2} (2\,A_1+ A_2)\,q $. From the last equation in \refeq{PKinvEqs3}, I get $w = -\frac{1}{e_2} (2\,A_1+ A_2)\,q$. Therefore, I get I get  $q = \frac{2 e_2\,u\,v}{c_2\,u+2\,c_1\,v}$}
...
\continue
g(u,v) &=&
 \left(w^2 - \PCedit{4\,}u^2 v\right)\left(c_2\,u+2\,c_1\,v\right)^2
 +\,2\,e_2^2\,u^2\,v^2 = 0
\,,\qquad  deg(g) = 6
\,,
\label{PKinvEqs5}
...
\DBedit{DB: I get $g(u,v) = \left(w^2 - 4\,u^2 v\right)\left(c_2\,u+2\,c_1\,v\right)^2 +\,4\,e_2^2\,u^2\,v^2 = 0$}

where if $w$ is used as defined by the first equation in
\refeq{PKinvEqs4}.
    \PC{should I use the syzygy \refeq{eq:syzPK},
\(
w^2 - 4\,u^2v = -q^2
\)?
}
...
\refeq{PKinvEqs4} I get
    \PC{to DB I still have that pesky factor of 2}
\beq

...
insights that I gained in the chaos course.
...
\nnu
\eea
We obtain two (bivariate)  polynomials in two variables $\{u,v\}$ with
...
\refeq{PKinvEqs4}, or their average. Up to a factor of 2 this equation as
what Lei had as of {[2012-04-26]} (Keith and Predrag had checked some of
the algebra):
    \bea
...
roots of bivariate polynomials is not easy. As a matter of fact, you can
learn all about it on Sunday:
...
\beq
\left\{u\to \frac{b_2 \mu_1 -b_1 \mu_2 }{a_2
   b_1-a_1 b_2},v\to \frac{a_2 \mu_1 -a_1
   \mu_2 }{a_1 b_2-a_2 b_1},w\to 0,q\to
   \frac{(b_1 \mu_2 -b_2 \mu_1 ) (-a_1 c_1
   \mu_2 +a_2 c_1  \mu_1 +b_1 c_2  \mu_2 -b_2 c_2  \mu_1 )}{e_2 (a_2 b_1-a_1
   b_2)^2}\right\}
\label{invroot2}
\eeq
Haven't messed around with parameters in \refeq{invroot2} though...

\item[2012-04-29 Predrag] As $w = 2\,u |v|^{1/2} \cos \psi$, vanishing
$w$ implies that $\psi = \pi/2$. Cannot see the symmetry that would
impose it. Wonder why would that be a solution? Perhaps because of the
funky $\On{2}$ symmetry breaking $e_2$ term. As $w$ and $q$ are the same
thing up to $\psi$ rotation by $\pi/2$, you might also find solutions
with $q=0$...

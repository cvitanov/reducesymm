...
that it was wrong (factors of 2 and $u$ and $v$ were switched in the term in parentheses in the equation for $q$). Verified that my corrected solution was fixed point of the \twoMode\ system using Matlab. Uploaded relevant code as \texttt{/siminos/cgang/Daniel/Matlab/W0EquilibriumCheck.m}.

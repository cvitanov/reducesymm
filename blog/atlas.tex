...
\item[{[ ]}] Every author needs to read the paper and ok it. \DB{}{This
should have been done before we submitted to Chaos, but at least we can
change that before it gets published. Once it goes on arXiv, it is
effectively published and has your name on it, so read it carefully!}
		\begin{description}
			\item[{[ ]}] Keith
			\item[{[ ]}] Bryce
			\item[{[ ]}] Lei

...
\edit{blue/full} trajectory, closely follows the \edit{green/dotted}
trajectory after the singularity point, reaches the other side of the
\edit{green/dotted} arc and then resumes closely following the
\edit{blue/full} trajectory (from \refref{FrCv11}).
    }%
 \end{figure}

...
\item[{[ ]}] Every author needs to read the paper and ok it.
    ...
    it carefully!}
    \PC{[2012-05-16] Looks like Daniel's message is too subtle, so let me spell it out:
    You do not proofread the article currently listing you a co-author, you get voted
    off the island.}
		\begin{description}
			\item[{[ ]}] Keith
			\item[{[ ]}] Bryce

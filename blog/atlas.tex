...
\end{align}
(I have replaced symmetry breaking term $e$ here and in \ref{eq:AGpolar} 
with $e_2$ since in this constant is naturally paired with $\mu_2$.)
In \texttt{siminos/cgang/Evangelos/dangelmayr\_so2\_int.nb} 
I integrate this form rather
than the polar form \ref{eq:AGpolar} as it has no dangerous denominators.
...
has to derive the correspondance of parameters, so that we can properly cite 

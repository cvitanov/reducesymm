...
\item[2012-04-26 Lei to Keith] Yes. Zero should be a equilibrium. I just omit it by manipulatig algebraic equations...

\item[2012-04-26 Lei to Evangelos] I just use the first two equtions in the polar coordinates and eliminate $\psi$. What I got is
\begin{align}
\frac{(\mu_1 r_1+a_1 r_1^3+b_1 r_1 r_2^2)^2}{c_1^2 r_1^2 r_2^2}+\frac{r_2^2 e^2}{(c_1 r_1^2+2 c_1 r_2^2)^2}&=1\\
\frac{(\mu_2 r_2+a_1 r_1^2 r_2+b_2 r_2^3)^2}{c_1^2 r_1^4}+\frac{r_2^2 e^2}{(c_2 r_1^2+2 c_1 r_2^2)^2}&=1
\end{align}

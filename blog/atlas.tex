...
$\On{2}$ symmetry \refeq{eq:AG} does have ratios of form $r_0/r_1$, when
...
In our paper \refref{SiCvi10} I've tried to avoid singularities by modifying the
...
\item[2012-04-02 Keith] Have working return map for the R\"ossler...Hopefully the image is attached above.  I will post the code when I clean it up and comment it; it is too Keith cluttered currently.  Does anyone know how to put an \"o into matlab titles/strings?

\begin{figure}
\begin{center}
  \includegraphics[width=0.6\textwidth,clip=true]{RosReturnMap.png}
\end{center}
  \caption{
  R\'ossler return map.}
\label{fig:RosRetMap}
...
\begin{figure}
\begin{center}
  \includegraphics[width=0.6\textwidth,clip=true]{Rossler1Period.png}
\end{center}
  \caption{
  R\'ossler periodic orbit.}
\label{fig:Ros1Per}
\end{figure}

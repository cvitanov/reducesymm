...
special term, the period is placed outside the quotation marks:
    ...
    Bryce was not familiar with the word 'heteroclinic'.

\item[2012-04-22 Bryce] I've seen the format acheived with the R\"ossler figures and have reworked mine to specifications (should be a smallish enough size now) see figure \reffig{fig:newRoss}. They are currently in jpeg format but can be converted into pdf if desired. Either way, I'm on to investigating the 2-mode model.

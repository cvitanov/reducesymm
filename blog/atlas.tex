...
for the section border? Both are used in the text. {\bf Predrag:} ${\cal
S}$ is more consistent with $\pS$ and $\PoincS$ notation.
...
other changes that are necessary. As far as \reffig{fig:CLEattractor}
...
\item[2012-04-11 Bryce to Gang] My plots in Mathematica are starting to look really good! I have TA duties for a few hours and will commit the final plots later this evening. Obligations, obligations...

\item[2012-04-10 Daniel] Inkscaped up \reffig{fig:A28extremum} to publication quality. See \reffig{fig:A28extremum2}. Source code is in /FigSrc/inkscape.

\begin{figure}[h]
	\begin{center}
  	\setlength{\unitlength}{0.25\textwidth}
  	\begin{picture}(1,0.62007592)%
    	\put(0,0){\includegraphics[width=\unitlength]{A28extremum2.pdf}}%
    	\put(0.8274739,0.27313042){\color[rgb]{0,0,0}\makebox(0,0)[lb]{\smash{$\mathcal{M}_x$}}}%
    	\put(0.71822871,0.05712263){\color[rgb]{0,0,0}\makebox(0,0)[lb]{\smash{$t'$}}}%
    	\put(-0.00055527,0.03229441){\color[rgb]{0,0,0}\makebox(0,0)[lb]{\smash{$\hat{x}'$}}}%
    	\put(0.50966967,0.33520145){\color[rgb]{0,0,0}\makebox(0,0)[lb]{\smash{$\hat{x}$}}}%
  	\end{picture}
  \end{center}
  \caption{\label{fig:A28extremum2}
  Inkscaped version of \reffig{fig:A28extremum}}
\end{figure}

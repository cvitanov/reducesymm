...
\item[2012-06-15 Daniel to CGang] Made another through sections I-III. Put in some minor edits, nothing of substance. Did find one thing that I wasn't sure what it meant and is probably a cadaver from an earlier iteration of \reffig{fig:RoessTrjs}. In the description for subfigure \ref{fig:RoessTrjs}\,(c) what is meant by ``(here viewed from below)''? Should this be removed? \bf{To Keith:} To give yourself a color for KCedits you need to go \texttt{/siminos/atlas/defAtlas.tex} and just look for the line that defines KCedit and the lines that define PCedit, ESedit, or DBedit and copy the format to your line. You can pick whatever color you like.

...
+\frac{u_2 e^2}{(c_2 u_1+2 c_1 u_2)^2}  &=& 1
    \continue
 \frac{u_2 \, (\mu_2 +a_1 u_1 +b_2 u_2)^2}{c_2^2 u_1^2}
+\frac{u_2 e^2}{(c_2 u_1+2 c_1 u_2)^2}  &=& 1
\label{2modefixdenom}
\eea

in other words, the denominator on the $e^2 u_2$ terms in both equations should be the same since this comes from the $cos(\psi)$ term.  Also check your denominators on the other, I have $c_2$ instead of $c_1$. I haven't checked if the original reduces down this in polar coordinates, but maybe I should tonight.

...
\bea
\dot{x_1} &=& a_1 x_1^3 + b_1 x_1 x_2^2 + c_1  x_1  x_2 + a_1  x_1 y_1^2 + b_1  x_1 y_2^2 + \mu_1  x_1 + c_1 y_1 y_2
\continue
\dot{y_1} &=& a_1  x_1^2 y_1 + c_1  x_1 y_2 + b_1  x_2^2 y_1 - c_1  x_2 y_1 + a_1 y_1^3 + b_1 y_1 y_2^2 + \mu_1 y_1
\continue
\dot{x_2} &=& a_2  x_1^2  x_2 + c_2  x_1^2 + \mu_2  x_1 + b_2  x_2^3 + a_2  x_2 y_1^2 + b_2  x_2 y_2^2 - c_2 y_1^2 + e_2 y_1
\continue
\dot{y_2} &=& a_2  x_1^2 y_2 + 2 c_2  x_1 y_1 - e_2  x_1 + b_2  x_2^2 y_2 + a_2 y_1^2 y_2 + \mu_2 y_1 + b_2 y_2^3
\label{2mode4D}
\eea
...
\item[2012-04-26 Daniel] Uploaded code to \begin{verbatim}\siminos\cgang\Daniel\Matlab\end{verbatim}. Just type EOMComplexTo4D at the Matlab prompt and it will calculate the system in 4D Cartesian, 4D polar, and 3D polar coordinates. The $\dot{z_j}$ equations can be modified within the code if need be.
For future reference, our 2-mode system \refeq{eq:AGpolar} is a special case ($\omega_1 = 0$) of the system of Porter and Knobloch\rf{PoKno05}. They are related by (P\textit{\&}K $\leftrightarrow$ ChaosGang 2-mode):

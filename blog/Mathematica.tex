...
\item[2012-08-08 Daniel] I know we don't like Lyapunov exponents, but since I already had the code written up from a long time ago and all I had to do was give it the equations of motion and the Jacobian, I calculated them out anyway for Predrag's parameters \refeq{pars2012-08-06}. The code uses the method proposed by Eckmann and Ruelle \rf{eckerg}. Anyway, the Lyapunov spectrum (in descending order)is something like $(0.1,0,0,-0.2)$ with a Kaplan-Yorke dimension of $3.4$.

...
importance as a model for flame fronts\rf{siv} and
phase turbulence\rf{KS}
and plasmas\rf{LMRT} the
KS equation has become
one of the canonical models for
spatio-temporal chaos in $1\!+\!1$ dimensions
\rf{JOHNSON,KEVREKIDIS,Man}.

Nicolaenko, Scheurer and Temam\rf{NICO} gave the first long-time
...
Stubbe\rf{CEES} who  extended it to any mean-zero initial data and improved the exponent from
$\frac{5}{2}$ to $\frac{8}{5}$,
and by Goodman\rf{Good}, who extended it to
...
Ilyashenko\rf{Ilyashenko},
Otto  and Giacomelli\rf{GO}.
...
go by the name `background flow method.'\rf{CD1,CD2}

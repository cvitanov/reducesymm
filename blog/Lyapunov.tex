...
Ginelli \etal\ algorithm, and it works much better.
  ...
  \item V. Lucarini, {\em Parametric smoothness and
	...
	ESedit{\item   	Evangelos, 2009-12-2: Read part of Lucarini and Saltzman\rf{saltzman1962} papers. 
			It appears that Lucarini is wrong, the system cannot have $\SOn{2}\times\SOn{2}$. 
			...
			satisfy boundary conditions. Saltzman (and of course Lorenz\rf{lorenz}) appears to

...
svn repository
\\
vaggelis/production/KS22.0/rpo/ks22rpo016.31\_02.863/Jdiag.dat
\\
...
I also tried to calculate the Lyapunov exponents associated to this {unstable \po}.
The largest is about 0.03328, right? I'm not yet really sure about this value,
so it would be nice if you let me know the Lyapunov exponents you know for this {unstable \po}.
...
exponents) are exactly what I confirmed with that {unstable \po}. I will soon have all
the necessary information regarding the physical/spurious modes for that {unstable \po}.
\item[2011-02-11 Kaz:] Which quantities/properties do you have
analytically/numerically for these {unstable \po}s in your methods? For instance,
if we know the time evolution operator for a {unstable \po}, we can compute both
...
Given an initial condition $x_o$ and period $T$ for a {unstable \po}, we integrate
...
(the covariant Lyapunov vectors for {unstable \po}s). Then the i'th Lyapunov exponent is
$\mu_i = \ln(|\Lambda_i|)/ T$

...
% $Author: predrag $ $Date: 2009-10-19 15:52:23 +0200 (Mon, 19 Oct 2009) $

\chapter{Lyapunov vectors}
\label{s:LyapunovVec}

This part of the blog focuses on use of `covariant Lyapunov
...
marginally positive/negative Lyapunov exponents, and twice it's
...
\item[On the concept of stationary {L}yapunov basis:]
    Ershov and Potapov\rf{ErshPot98}. Alex Potapov papers
    are available on
    \HREF{http://www.math.ualberta.ca/~apotapov/Publications.htm}
    {http://www.math.ualberta.ca/$\sim$apotapov}.
...
\begin{figure}
 (c)~\includegraphics[width=0.40\textwidth]{../figs/eigenvalues.ps}
...
{\bf G}_{n-1} \to \overline{\bf G}_n =
 {\bf G}_n^T {\bf R}_n
 \to
{\bf G}_{n+1}^T {\bf R}_{n+1}{\bf R}_n
\]
where ${\bf G}_n$ is an orthogonal frame spaning the tangent
space at $\ssp_n$, and
 \[
...
eigen-exponents of the linearized flow.
...
ocean data available.
  ...
  \item A. Trevisan and O. Talagrand, {\em On the
      existence of an optimal subspace dimension for
        4DVar }
  \item M. Ghil, {\em Data assimilation and
      predictability in climate models} explained
      Kalman filters in detail that might be useful for
      including into Lippolis thesis.
...
\refsect{sect:2009-09-16}. The idea is this: there is always a

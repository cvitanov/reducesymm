...
\item[2015-05-03] I have changed Burak's $\Delta_{\Obser}$ to
    $\Delta_{\obser}$, as $\Obser^\zeit$ depends on time, but $\obser$
    does not.
\item[2015-05-06]
Why not just use $\Delta\obser$? That notation is pretty typical 		
in quantum mechanics, right? Like when we write the Heisenberg

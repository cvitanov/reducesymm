...
Rescuing back what we
squirreled away for the thesis from material omitted form the KS papers.
Predrag moved the material to thesis from blog/flotsam.tex on June 26 2008,
...
invariants given in \reftab{tab:SO2n6modif}. Shown are 20
...
(see the discussion in the blog, however)

\noindent{\bf PC 2009-10-05:}
...
\subsection{Numerical searches for \reqva\ and \rpo s}
...
\subsection{Example dynamical systems used throughout the thesis}
...
\subsection{ChaosBook.org chapter continuous.tex}
...
the isotropy subgroup $\Group_{{x}}$ can be any continuous or
discrete subgroup of $\Group$.
    \ES{Not always, for reasons illustrated by
        the $D_3$ example.}

...
\end{center}
\caption{
The three generators of tiling of the plane by a
fundamental domain: two generators of \Dn{12} tiling,
$s$ reflection across the short disk-disk separation and
$\ell$ reflection across the long disk-disk separation;
and
...
\begin{figure}
\begin{center}
\includegraphics[width=0.59\textwidth]{7diskFundDflips2}
\end{center}
\caption{
The three generators of tiling of the plane by a
fundamental domain: two generators of \Dn{12} tiling,

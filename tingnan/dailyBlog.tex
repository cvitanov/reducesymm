...
\begin{figure}
\includegraphics[width=\textwidth]{7diskFUndDtilesEquiv.pdf}
...
I think we should propose a separate label $\circ$ to indicate the collision on the disk, i.e. $\cycle{\circ f}=\cycle{06}$. Without the additional symbol, when we are doing the string reduction things could go wrong. 

...
will map the fundamental domain to the same piece. Here I list the
equivalence relation for shortest (length 2 and 3) symbol sequences (see
...
Those two are probably all the shortest equivalence relations, and I
think longer sequences can be reduced:
\bea
\cycle{f\ell s\ell f \ell fs}
  &=& \cycle{sf\ell s\ell f \ell f}
    = \cycle{fs\ell s\ell f \ell f}

...
\item[05-23-2014] I think I in my and Shreiber's numerical calculation for the diffusion coefficients we have missed the dimension $\nu$ at the denominator \ref{TS:formula}. Now results are updated :p. Should we say that now both Lyapunov and diffusion coefficient are converged? 

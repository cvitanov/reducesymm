...
(b) Elementary cell short clockwise 3-cycle $\cycle{042\underline{10}4}$, and
...
fundamental domain $\cycle{0\underline{10}8642}=\cycle{(slfl)^6}$.
    }
\label{7diskFundDflips2}
\end{figure}
%%%%%%%%%%%%%%\item[Figure 4]%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\item[2014-06-02 Predrag]
\refFig{7diskFundDflips}: Pavel's three generators. The standard notation
...
is then generated by adding a translation generator $f$ that pivots a
disk center to disk center by flip across the symmetry line normal to the
short disk-disk separation. Few relations:
\[
\ell r = C_6^-
\,,\qquad
r \ell =  C_6^+
...
of orientation, and $sf$ which changes it. For practice, let's work out a
...
Have not rechecked any of this yet.

...
The Lorentz gas\rf{L} is one of the simplest nontrivial models
...
in \refref{gasPRL}, with the diffusion constant related to
...
this approach has been shown to be effective\rf{gaspbaras}.
...
A recent approach, introduced in \refref{CEG} and
...
In the periodic Lorentz gas\rf{L}
a point particle reflects elastically off
a periodic array of reflecting disks in a plane.
The system can
be thought of as an unfolding of the Sinai billiard\rf{S}.
...
Machta and Zwanzig\rf{MZ} have given numerical results
...
cell, originally given in \refref{CEG} (which contains
...
The associated Ruelle zeta function is then (see e.g. \refref{AAC1}
for details)
...
The first main result of  \refref{CEG} is that
...
in\rf{CE2}, the convergence of cycle expansions for dynamics

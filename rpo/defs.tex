...
\newcommand{\ES}[1]{$\footnotemark\footnotetext{FW: #1}$}
...
\newcommand{\Reqv}{Relative equilibrium}
% \newcommand{\Reqv}{Equivariant equilibrium}
\newcommand{\reqva}{relative equilibriia}
% \newcommand{\reqva}{equivariant equilibriia}
\newcommand{\Reqva}{Relative equilibriia}
% \newcommand{\Reqva}{Equivariant equilibriia}

\newcommand{\Loop}{L}
\newcommand{\costF}{F^2}  % cost function, as in crete03.tex
\newcommand{\lSpace}{\tilde{x}}                 % a point on a loop
\newcommand{\lVeloc}{\tilde{v}}
\newcommand{\pVeloc}{v}         % loop tangent

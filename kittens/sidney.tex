...
The spaciotemporal cat is the arbitrary dimension generalization of the 1-D Bernoulli map.
(mod 1) subtracts the integer part of s$\phi_t$, this keeps $\phi_{t+1}$ within the unit interval (group theoretic analogous?). Also partitions the state-space into s sub-intervals

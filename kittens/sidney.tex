...
$\Xx_\Mm(\phi_z)$ as a singular fixed point, but I do not understand $\textit{l}_i$.
	\item[A15.1]
...
I will no answer any of the questions quite yet. But I have rewritten the
...
\begin{itemize}
	\item[Update]
I read through, and aside from some very minor grammar issues (forgetting a "have" after "we" and forgetting a closed parentheses etc.) it all makes sense.
\end{itemize}

...
$(\mathbf{a}_{1},\mathbf{a}_{2})$.
    \PC{2020-09-05}{
Explain Bravais {\em lattice} invariance under \SLn{2}{\integers} Bravais cell
mappings, give literature reference (to modular group?).
    }
...
\PC{2020-06-16 Predrag}{
The number of Bravais lattices is\rf{Lind96}
    }
...
continuum to integer lattice $\integers^d$.
    ...
    \PCedit{ %2020-09-05
For brevity, we shall refer to lattice state $\Xx_{\Lambda}$ as a
\emph{\twot} if it satisfies
\beq
\Xx_{\Lambda}({z} + {R}) = \Xx_{\Lambda}({z})
\ee{dDprimePO}
...
where $\{n_{1},n_{2}\}$ are any integers, and
$(\mathbf{a}_{1},\mathbf{a}_{2})$ is a pair of $\integers^2$ integer
lattice vectors that define a \emph{Bravais cell}.
We shall always refer to a Bravais sublattice by its unique
{Hermite normal form} {Bravais cell} \refeq{Hermite2d}, and
denote it
$\Lambda=\LTS{}{}{}$.


COMBINE WITH RELATIVE
we shall refer to 2\dmn\ doubly-periodic \spt\ lattice state $\Xx$
\beq
...
\ee{Woods12p6}
as a \emph{\twot} with periods $(\speriod{},\period{})$.
    ...
    \PCedit{ %2020-09-05
To correctly define  a {\em prime}
{\twot}\rf{DasBuchMirror},

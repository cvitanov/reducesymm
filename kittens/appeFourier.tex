...
discretizations of Helmholtz\rf{DiHaHu01}
and screened Poisson%
\rf{Dorr70,GoVanLo96,HuCon96,HuRyCo98}
(also known as Klein–Gordon) equations
...
\rf{Glaser70,BuGoNi70,Wood71,KMIHA71,KatIna71,KaInAb71,Morita71,
    ...
    Economou79,AndMor85,varcyc,PerViv,ChenM87,ChuYau00,dlLlave00,
...
stability of {\spt}ly periodic orbits in coupled map
lattices\rf{AGGN91,GadAmr93,ZGBG94}

{\HillDet}\rf{MacMei83,BolTre10};
...
\rf{Ihara66,BowLan70,Serre80,Hashimoto89,Bass92,
    ...
    Clair14,LePoSc14,ZhXiHe15,Deitmar15,AGHN18}
...
&=& \prod_{n_1=0}^{\speriod{}-1} \prod_{n_2=0}^{\period{}-1}
     \left[ 2s - 2 \cos(\frac{2 \pi n_1}{\speriod{}})
             - 2 \cos(-\frac{2 \pi n_1 \slant{}}{\speriod{} \period{}}

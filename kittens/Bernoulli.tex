...
% $Author: predrag $ $Date: 2020-09-30 22:58:31 -0500 (Wed, 30 Sep 2020) $
...
exhibits two unrelated lattices:
\begin{itemize}
  \item[(i)]
In the latticization of a time continuum, one replaces \emph{any}
...
\,.
\ee{LnDet=TrLn}
It follows from $\hopMat^\cl{}=\unit$ that
$\Tr \hopMat^k= \cl{}\delta_{k,r\cl{}}$ is non-vanishing
...
\,,
\ee{detDet}
of which \refeq{detBern2n} is the simplest example.

...
here:
      \begin{enumerate}
        \item $\spaceAver{u}$ =0
        \item Satisfy the same boundary condition. {\bf PC} \PCedit{what
        boundary conditions? Refer by equation numbers to
        \refsect{chap:KSreview} text where you have (should have) defined
        and explained the \KSe.}
      \end{enumerate}
...
solution $u(x,t)$ of \KSe\ in such functional basis is
  ...
  \beq \be_m=u_m(x,t): \max \Norm{u_m(x,t)-u(x,t)}
        \,,
  \eeq
where $u_m(x,t)$ is in the same \rpo\ as $u(x,t)$.

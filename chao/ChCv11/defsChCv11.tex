...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% defines macros used throughout DuCv11.tex
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Predrag edits, from siminos/inputs/defsFroelich.tex
...
\else % prepare hyperlinked pdf
	   ...
	   \hypersetup{
   pdfauthor=William Dupre and Predrag Cvitanovic,
   pdfkeywords=??,
   pdftitle=Reducing ??
   	   }
\fi
...
\ifboyscout %%%%%%%% DISPLAY COMMENTS IN THE TEXT %%%%%%%%%%%%%%%%%%%%
  ...
  \newcommand{\WD}[1]{$\footnotemark\footnotetext{Will: #1}$}
  \newcommand{\WDedit}[1]{{\color{magenta}#1}}
...
\newcommand{\Lg}{\ensuremath{T}}   % DuCv11.tex Lie algebra generator

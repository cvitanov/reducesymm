...
{}{
This figure `Smale Horseshoe.???' is missing - please svn add it to
siminos/figs/ . Also best to omit spaces from file names (causes
confusion in linux), so call it something like SmaleHorseshoe.*.
    }{Fig:SmaleHorseshoe}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

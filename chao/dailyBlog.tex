...
\item[2011-03-31 CS] Sorry about that. I undo the \texttt{svn-multi} because otherwise I can not compile the .tex file and generate pdf document. I have not yet find another way to reconcile the \texttt{svn-multi}. Before that I can make two versions, one with \texttt{svn-multi} commented kept for my own use and one the same with this for your convenience.

\item[2011-04-05 CS] Worked out exercise 2.1. Finished Chapter 9 with all the details in the example, have had exemplified pictures of symmetry and group actions.

    A question about the last sentence in the first paragraph of Section 5.4(Chapter 5) proposed in the group study last week: Why the neighborhood size scales as $1/|\Lambda_{p}|$? Wouldn't it scales as |\Lambda_{p}|?

...
\item[2011-4-22 CS] You're right. I checked the proof again and found out that in the map of p, I missed a factor $\frac{a_1}{a_2}$ in front of $p_1$ and other two $\frac{1}{a_2}$ before the rest two terms. Now the result is happy.
It seems that caffeine can not perfectly replace sleep.

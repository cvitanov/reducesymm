...
\edit{projections onto three orthonormal vectors $\mathbf{v}_1$, $\mathbf{v}_2$, and $\mathbf{v}_3$, respectively,}
...
\caption{ Heteroclinic connections on $\bbU^+$:
 ...
 The unstable manifolds of $\Shift_{1/2}$\EQV{1} and $\Shift_{1/2}$\EQV{2} have been omitted

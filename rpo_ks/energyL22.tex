...
connections from \EQV{2} to $\EQV{3}$ (green),
...
\reffigs{f:drivedrag}{f:drivedragConn}, can be misleading. Another example is
...
it, \reffig{f:ks22rposShort}\,(\textit{c}), is quite close to the long-time
turbulent time average $\timeAver{P}$.
    \PC{
    why is this orbit not mentioned in the caption of
    \reffig{f:drivedrag}? Please make sure captions contain all
    information needed.
    }

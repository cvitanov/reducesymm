...
\refFig{f:ks22rposT} shows the \rpo s in the plane $(\period{},\shift)$. Not much
...
\PC{
   \reffig{f:ks22rposT} needs $\Delta\to \shift$. If you document the
...
\reffig{f:ks22rposL}. In this case a tendency of accumulation toward the
Lyapunov exponent
...
it possesses (see \refsect{ssec:po}).
\PC{
    please refer to the exact equation for this symmetry.
    } 

...
\reffig{f:ks22rposT} shows the \rpo s in the plane $(T,\shift)$.
\begin{figure}[t]
\begin{center}
...
the condition (\ref{eq:RPOcond}) for \rpo s). \RLD{It looks like there
...
with symmetry (2) within $T < 200$ as there are \rpo s within $T <
...
than $T/2$ should be approximately equal to the number of \rpo s with

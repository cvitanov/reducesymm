...
$\shift > 0$.
(b) The largest \PCedit{Lyapunov} exponents \ref{FloqExp} of all \po s
...
The stability of the orbits is determined by their \PCedit{Lyapunov} exponents,
defined as
\beq
...
largest \PCedit{Lyapunov} exponents
...
\PCedit{Lyapunov} exponent equal 0.328.  The other short orbits are less
unstable, with the largest \PCedit{Lyapunov} exponent, $s_1$, in the range
0.018 -- 0.073.

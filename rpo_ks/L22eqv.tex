...
$\mathrm{Re} a_k$ and $\mathrm{Im} a_k$. \refTab{tab:E1_sym} to \reftab{tab:E3_sym}
...
RE1 and RE2 are listed in \reftab{tab:RE}.  The eigenvectors
...
\begin{tabular}{ccc|ccc} \hline
  \multicolumn{3}{c}{RE1}  & \multicolumn{3}{c}{RE2} \\\hline
...
of \refeq{eq:3dks} for $c$ corresponding to each on of $\EQV{1},\EQV{2}$ and $\EQV{3}$ \eqva.

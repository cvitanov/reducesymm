...
($\tildeL/\sqrt{2}= 2.4758\ldots$, %see \refsect{s:StabEqui}),
...
with small \ESedit{$k=2j$, $k=3j$} harmonics deformations.
...
\EQV{2}
\PCedit{translated set of solutions}
% continuum.
...
shift $\shift_p > 0$.
(b) The largest Lyapunov exponents \refeq{FloqExp} of all periodic
...
of the chaotic dynamics discussed in \refSect{sec:L22}, for all
periodic and \rpo s we have found, only four \PCedit{Lyapunov}
...
\begin{figure}[t]
\begin{center}
%\includegraphics[width=0.9\textwidth]{figs_bmp/ks22rposShort.eps}
...
%We have found over 50 \po s with $\period{p} < 200$, with
...
\reffig{f:ks22rpos}(\textit{i-l}).  Several \po s have been found by the same
...
\begin{figure}[t]
\begin{center}
(\textit{a})\!\!\!\!\includegraphics[width=0.46\textwidth]{figs_bmp/energyBalance_pst.eps}%
~(\textit{b})\!\!\!\!\includegraphics[width=0.46\textwidth]{figs_bmp/equivaEP_pst.eps}
\end{center}
\caption{
...
\begin{figure}[t]
\begin{center}
(\textit{a})\!\!\!\!\includegraphics[width=0.46\textwidth]{figs_bmp/connEP.eps}%
~~(\textit{b})\!\!\!\!\includegraphics[width=0.46\textwidth]{figs_bmp/connPEdot.eps}
\end{center}
\caption{
...
%\PCedit{determined so far},
selected \rpo, and for a typical `turbulent' long-time
trajectory.
\PC{\reffig{f:drivedrag} (b) is it $D$ as in the caption,
    or $P$, as in the figure label? ES: The figure is correct, I've corrected the caption.}
...
magic\ES{Perharps drop or replace word ``magic'' here? Couldn't it sound offending for Kawahara and Kida (and other heretics)?}
...
\begin{figure}[t]
\begin{center}
(\textit{a}) \includegraphics[width=0.35\textwidth]{figs_bmp/ks22rpo033.50_04.045E2.eps}
(\textit{b}) \includegraphics[width=0.35\textwidth]{figs_bmp/ks22rpo033.50_04.045E2CM.eps}
\\
\end{center}
\caption{
 The

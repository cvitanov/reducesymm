...
In addition, the \eqva\ \EQV{2} and \EQV{3} are symmetric with respect
...
\eqv\ are listed in \reftab{tab:Eksym}. Recall that an \eqv\ with $\mathrm{Re}
...
% with $L = 22$.
(b)
\Reqv\  \REQV{+}{2}, on the bifurcation branch starting

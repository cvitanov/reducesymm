...
\begin{figure}[t]
\begin{center} 
(a)\includegraphics[width=0.45\textwidth]{figs/lambdaUnstab}
(b)\includegraphics[width=0.45\textwidth]{figs/lambdaUnstabSymm.eps}
\end{center}
\caption{
...
of eigenvectors of \KS\ equation {\eqva} with $L = 22$.
        }
\begin{center} \footnotesize
\begin{tabular}{cccc} \hline
...
\begin{center} 
% \includegraphics[width=0.5\textwidth]{figs/ks22cage.eps}
\end{center}
\caption{
\PCedit{

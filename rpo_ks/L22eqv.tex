...
that we specilaize to for the rest of this paper
...
%\PC{\PCedit{replot \reffig{f:KS22Equil} with Ruslan's $u$ scale,
...
\PC{
    ...
    \\
    $A(L/4)\EQV{n}$ Symmetry by $\tau_{1/r}$
    \\
...
\reffig{f:KS22E2man1}\,(\textit{a}). Computed the 2 expanding eigenvectors

...
center manifold. Indeed,
numerically the leading Lyapunov exponents of the
$L=22$ chaotic attractor are
$(\Lyap_i) = (0.048, 0, 0, -0.003, -0.189, -0.256, -0.290, \cdots)$,
so the chaotic dynamics is mostly takes
...
number of Fourier modes truncations, of order of $d=10^2$
for the system studied here, suffices to obtain
numerically accurate (within $d=10^{-7}$) invariant
solutions.

...
We start by determining all \eqva\ and \reqva\ and a large set
...
we find two \reqva\ with velocities $c = 0.73699$ and $0.34954$
...
\begin{table}[h!]
    \caption{Properties of \eqva\ and \reqva\ determining
    the system dynamics in their vicinity.  $T$ is characteristic
    time scale of the dynamics, $\ExpaEig_r$ and $\ExpaEig_1$ are the
    expansion and contraction rates.}
\begin{center} \footnotesize
    \begin{tabular}{l|rrrr}
                 & $E$     & $T$    & $\ExpaEig_r$  & $\ExpaEig_1$  \\ \hline

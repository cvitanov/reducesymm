...
\eqv\ are listed in \reftab{tab:Eksym} in the order of
...
$\mathrm{Re} a_k$ and $\mathrm{Im} a_k$. \refTab{tab:Eksym} to \reftab{tab:E3sym}
...
% (b)\includegraphics[width=4in]{figs/L22-eqvaEigenvaluesR1.eps}
\end{center}
\caption{
...
\begin{table}
\caption{\label{tab:TW} Eigenvalues of the \reqva.} %\ for $L=22$.}
\begin{center} \footnotesize

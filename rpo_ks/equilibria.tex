...
thre is a bagel worth of the other \eqv\ solutions. But we have not
...
\beq
(k/\tilde{L})^2\left( 1 - (k/\tilde{L})^2  \right)a_k 
     + i (k/\tilde{L}) \sum_{m=-\infty}^{+\infty} a_m a_{k-m} = 0
\,.
\label{eq:stfks}
\eeq 

...
\PC{either drop this, or credit \refref{Lan:Thesis,LanKS}
    if we need it
   }
...
can do the job, previous work\rf{Lan:Thesis,LanKS}
...
In \refrefs{CvitLanCrete02,lanVar1,Lan:Thesis,LanKS} they are

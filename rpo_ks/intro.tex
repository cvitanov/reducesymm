...
We pursue this program in context of the \KS\ (KS) equation, %\rf{ku,siv}
...
and their unstable manifolds, in a PDE representation and DNS algorithm\ES{Isn't DNS specific to 
fluid mechanics? Perharps substitute with ``numerical simulation''}  
...
\PCedit{The focus in this paper is on the role continuous symmetries play in
...
between \eqva\ \ES{dropped: and \po s}, \refsect{sec:L22}. (c) Preponderance of

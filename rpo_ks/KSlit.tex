...
Kevrekidis, Nicolaenko and Scovel \refref{saddks} study \KSe\ steady state bifurcations and the role of symmetry in the existance of structurally stable (relative) homoclinic and heteroclinic connections between unstable saddles. The form  of the equation they use is
...
Those (relative) homoclinic connections \ES{In \refref{saddks} the characterization homoclinic connection is used. Here

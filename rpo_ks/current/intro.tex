...
chaotic flows this notion is too narrow; while Brown and
Kevrekidis\rf{BrKevr96} study of bifurcation branches yields
two MTWs, we compute 30,000 \po s and \rpo s. They are in no
...
each solution belongs to a manifold of equivalent solutions. \ESedit{In a 
forthcoming publication\rf{SCD09b} we resolve this puzzle by implementing
symmetry reduction.} Here we demonstrate that, \ESedit{for \rpo s visiting the

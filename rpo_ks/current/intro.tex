...
extensively, `spatio-temporally chaotic' or `weakly
turbulent.' Conversely, for small system sizes the accurate
description might require a large set of coupled ODEs, but
...
the spatially very large `turbulent' systems. The key aspect

...
\input defs     % all definitions in defs.tex
                ...
                \begin{document}
                \title{
\edit{On the s}tate space geometry of the
...
spatial translation symmetry leads to relative \edit{equilibrium}
(traveling wave) and relative periodic orbit
\edit{(modulated traveling wave)} solutions. The discrete
...
\bibliography{../../bibtex/siminos} %{rpo} PC: please, not zillion *.bib files

...
Armbruster \etal\rf{AGHks89} study
a fourth order truncation of KS dynamics on the
center-unstable manifold of $\EQV{2}$ close to a bifurcation
off the constant $u(x,t)=0$ solution and are able to prove
existence of a heteroclinic connection, see also
...
the onset of the 2-cell branch in terms of the symmetry and
flow invariant subspace of the problem. Here we adapt
arguments of \refref{KNSks90} to explain the new heteroclinic
connections we have found for $L=22$.
}
    \PC{This received wisdom that heteroclinic connections
    ...
    of the \statesp, as explained in \refref{GHCV08}. Too
...
The dynamics of
\KS\ in the antisymmetric subspace and \po s with symmetry {\bf (a)} have
been investigated

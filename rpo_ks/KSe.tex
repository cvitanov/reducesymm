...
\PC{Ruslan, we need to finalize the convention here - what
authoritative reference uses $(u^2)_x/2$? I agree it's more
aesthetic, but best to use standard convention. I forget who we
follow.} \RLD{I've used the same convention as Kassam and Trefethen.
...
\end{center}
\caption{An example of turbulent solution of \KS\ equation.  The $x$
coordinate is scaled with the basic wavelength $2\pi\sqrt{2}$. }
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

...
\ee{KSshift}
\PCedit{
In the Fourier representation \refeq{expan} the \Refl\ reflection flips the odd modes,
\beq
  \Refl a_k = -a_k^\ast
% a_{2m} \to a_{2m}
%    \,,\qquad
...
\RLD{Actually, the reflection symmetry \Refl\ should not change the
modes at all.  It is $\Shift_{1/2}$ that flips the odd modes.
Right?}

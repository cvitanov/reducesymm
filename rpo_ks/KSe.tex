...
In the form of the equation adopted here, the time evolution of the 
...
%  T_p= T^*_p/\nu
% \ee{Trescl}
\PC{not sure it is handy to use $\tildeL={L}/{(2 \pi \sqrt{\nu})}$
    without explaining what it is, and relation to other literature.
    If you really want to do, fix $L \to 2 \pi\tildeL$ throughout,
    now you have $L$ various places instead of $2 \pi\tildeL$. Vaggelis, make sure
    that all the stuff you commented out here reemerges in your thesis}
\ES{I finally think I agree it is not pretty. For example a shift by $L/4$ now becomes $\pi L/2$ which does not look like
one fourth of the total length. We can discuss it again.}
The \KSe\  \refeq{ks} is
...
\begin{itemize}
 \item $S_1$: The space of antisymmetric functions,
 \item $R_1$: The space of L/2 periodic functions,

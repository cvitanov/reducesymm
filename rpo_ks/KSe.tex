...
$\shift_p$ has a symmetric partner $-u_p(-x)$ with shift $-\shift_p$.
    \PC{
Ruslan is right, for these preperiodic guys there is no shift.
I have tried to finalize the relevant text: there are

1) full-space RPOs (intrinsic continuous shift, no reflection)
2) full-space pre periodic  RPOs - or whatever professionals call these things
- (reflection, no intrinsic shift)
3) symmetric subspaces POs, no shifts
       }

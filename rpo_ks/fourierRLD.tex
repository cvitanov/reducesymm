...
Note that, since $a_k \in \mathbb{C}$, \refeq{eq:KS} represents a 
...
$\mathbf{g}(\shift) = \diag(\cos q_1\shift, \sin q_1\shift, \cos
  q_2\shift, \sin q_2\shift, \ldots)$\ES{I think this should be a block diagonal
matrix of the form \[ diag\left( \begin{array}{cc}

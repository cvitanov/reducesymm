...
\begin{itemize}
 ...
 \item Phase space structure ``blured'' - recurrence up to symmetry
...
\begin{sheet}{\CLe}
 ...
 \centerline{
		\includegraphics[width=.38\textwidth]{../../figs/CLE.eps}
}
\end{itemize}
...
\begin{itemize}
 \item All points on the same group orbit, \ie related by a symmetry operation
	are mapped to the same orbit

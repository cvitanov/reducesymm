...
\begin{sheet}{\CLe}
 ...
 \begin{tabular}[t]{cc}
 \includegraphics[width=.45\textwidth]{../../figs/CLE.eps} & 
 \begin{minipage}{0.45\textwidth}
	\begin{description}
	  ...
	  \item[$01$:]  relative periodic orbit ($x(0)=\Rot{\theta_p}x(T)$ for some $\theta_p$ and $T_p$, modulated traveling wave in PDE's)  with $T_{01}=1.542,\, \theta_{01}=2.953$.	
	\end{description}
 \end{minipage}
\end{tabular}
...
\end{itemize}
	...
	\begin{center}
	\begin{tabular}{cc}
		\includegraphics[width=.38\textwidth]{../../figs/CLEip1.eps} &\includegraphics[width=.38\textwidth]{../../figs/CLEmfXYZ.eps} \\ 
		(\textit{a}) & (\textit{b}) 
	\end{tabular}
	\end{center}

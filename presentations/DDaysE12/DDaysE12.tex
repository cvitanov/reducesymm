...
\begin{center}
  ...
  {CLEcompact}
  \only<2>{\includegraphics[width=0.3\textwidth,clip=true]
  {CLEWurst01} }
\end{center}
\end{block}
\begin{itemize}
...
\begin{frame}{How to symmetry reduce?}
...
\begin{frame}[t]{The method of slices}
 \begin{block}{}
  ...
  \begin{itemize}
    ...
    \item Point on reduced space point is $\overline x(\tau) = g(\theta)\ssp(\tau)$
  \end{itemize}
 \end{block}
%   \only<2>{ 
%     \begin{block}{}
...
\begin{frame}{Application in CLe}
 \centering
  \includegraphics[width=0.25\textwidth]{CLEchaotic}~~~~
  \includegraphics[width=0.25\textwidth]{CLEmfAdHoc245}~~~~
  \includegraphics[width=0.25\textwidth]{CLEinvRM}
\end{frame}
...
\only<2>{ \\
	\includegraphics[width=0.24\textwidth, clip=true]{ks22torRPO1} &
	\includegraphics[width=0.24\textwidth, clip=true]{ks22torRPO2} &
	\includegraphics[width=0.24\textwidth, clip=true]{ks22torRPO3}
}
\only<3>{\\
	\includegraphics[width=0.24\textwidth]{ks22rpoShadFM} & & 
}
\only<4>{\\
	\includegraphics[width=0.24\textwidth]{ks22rpoShadFM} &  
	\includegraphics[width=0.24\textwidth]{ks22rpoT47p32s0p3templ} & 
}
\only<5>{\\
	\includegraphics[width=0.24\textwidth]{ks22rpoShadFM} &  
	\includegraphics[width=0.24\textwidth]{ks22rpoT47p32s0p3templ} & 
	\includegraphics[width=0.24\textwidth]{ks22rpoShadSingleChart} 
}
  \end{tabular}
\end{center}
\end{frame}

 ...
 \end{block}
  \only<2>{ 
	...
	\item In general several slice hyperplanes $\overline{M}_i$ will be needed in order to cover the reduced space.\\
	      \flushright see http://cns.gatech.edu/~predrag/papers/atlas12.pdf
      \end{itemize}
    \end{block}
  }
\end{frame}
...
\begin{frame}{Application in CLe}
 \centering
  \includegraphics[width=0.4\textwidth]{CLEmfAdHoc245}~~
  \includegraphics[width=0.4\textwidth]{CLEinvRM}
\end{frame}
...
\begin{frame}{Symmetries of KSe in Fourier space - Fix this}
\[
    u(x,t)=\sum_{k=-\infty}^{+\infty} a_k (t) e^{ i k x /\tildeL }
\]
\begin{itemize}
 \item Truncate to finite order $d$.
 \item With $a_k=b_k+i\,c_k$
\end{itemize}
\[
\LieEl(\gSpace) \,=\,  diag\left(\barr{cc}
...
\begin{frame}{How are these relative periodic orbits related?}
  \begin{center}
  \begin{tabular}{ccc}
	% ES produced with siminos/matlab/ruslan/ks22export.m
	\includegraphics[width=0.3\textwidth, clip=true]{ks22rpoT16p31s2p9phys}\hspace{-3ex} &
	\includegraphics[width=0.3\textwidth, clip=true]{ks22rpoT47p32s0p3phys}\hspace{-3ex} &
	\includegraphics[width=0.3\textwidth, clip=true]{ks22rpoT64p51s2p5phys}\hspace{-3ex} 
  \end{tabular}
\end{center}
\end{frame}
...
\begin{block}{Ongoing work}
  \begin{itemize}
   \item Covering KS phase space with multiple charts  
  \end{itemize}
\end{block}

% based on reducesymm/QFT/blog.tex   May 18 2018
% from reducesymm/QFT/finiteQED.tex
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%



Vertex diagrams separate
...
\refeq{IRstruct(1)} is IR and UV finite, and the UV subdivergences are
cancelled by $L^{(2m)}$ counterterms in \refeq{PRD10-74-III(2.6)}. None

...
% problems in different areas of laser-matter interaction 
...
% (in collaboration with V. Saxena 
...
% At the mathematical level, the pertinent question is what
% are the indicators of chaos which are invariant under transformations consistent with the symmetries of
% the problem (e.g. Lorentz transformations for special relativity), see e.g.~\cite{motter03,motter09-1}. 
...
% there is still need to has been no elaboration on the physical

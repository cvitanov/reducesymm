...
\label{sliceSingl0}
\eeq
We shall refer to this neighborhood of a \template\ \slicep\ bounded by
its {\chartBord} and the ridges with other such linear neighborhoods as a
\emph{chart} $\pSRed_{\slicep} \supset \pS/\Group$, and to
\refeq{sliceSingl0} as the {\emph{border conditions}.

...
$\flow{\zeit}{\ssp}$, \reffig{fig:A27wurst}\,(b), and the continuous
...
recurrence. To quantify how close
is the state of the system now to a previously visited
...
\,.
\ee{innerproduct}
Given distances and neighborhoods, the next key notion is  \emph{measure}, or

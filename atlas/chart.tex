...
%% remember to insert A29-1ridge.eps into ChaosBook
 ...
 \begin{center}
  \setlength{\unitlength}{0.40\textwidth}
  %% \unitlength = units used in the Picture Environment
  \begin{picture}(1,0.90464122)%
    \put(0,0){\includegraphics[width=\unitlength]{A29-1ridge}}%
    \put(-0.00042675,0.82979313){\color[rgb]{0,0,0}\makebox(0,0)[lb]{\smash{$\sspRed(0)$}}}%
    \put(0.89273732,0.08744117){\color[rgb]{0,0,0}\makebox(0,0)[lb]{\smash{$\sspRed(\zeit)$}}}%
    \put(0.79512484,0.45688276){\color[rgb]{0,0,0}\rotatebox{-25.76142111}{\makebox(0,0)[lb]{\smash{$\pSRed{}^{(1)}$}}}}%
    \put(0.39457603,0.80421255){\color[rgb]{0,0,0}\rotatebox{-61.41291822}{\makebox(0,0)[lb]{\smash{$\pSRed{}^{(2)}$}}}}%
    \put(0.24958944,0.31373009){\color[rgb]{0,0,0}\makebox(0,0)[lb]{\smash{$\sspRed^*$}}}%
  \end{picture}%
 \end{center}
...
\begin{figure}
 \begin{center}
(a) \includegraphics[width=0.20\textwidth]{cLe-fullDB}
~~~~~~

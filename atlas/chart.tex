...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \PublicPrivate{}{
{\bf 2012-03-18 Predrag} A good slice can be defined only by a fully
equivariant template point, for \cLf\ the \eqv\ will not do, as it is in
the $\Group$-invariant subspace. I would try to use as a \template\ a
point on the \cycle{01} orbit in \reffig{fig:A29-2slices}\,({\it ba});
it is in some sense 'the furthest away' from the \reqv.

An interesting issue looming ahead. For 3 or more charts I am not sure
the shortest Euclidean distance argument works for curve manifolds.
    }

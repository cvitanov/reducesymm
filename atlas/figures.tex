...
\item[{[ ]}] \reffig{fig:RoessTrjs},
    ...
    \begin{itemize}
        ...
        \item[{[ ]}] [2012-04-07 Predrag] should have the same axes
            (including their scale) as \reffig{fig:RoessFarEq}
...
\item[{[x]}] \reffig{fig:RoessSct1} to flotsam, replaced by \reffig{fig:RoessTrjs}\,(b),
             \reffig{fig:RoessFarEq}
\item[{[x]}] \reffig{fig:RoessSct1} to flotsam, replaced by \reffig{fig:RoessFarEq}

...
symmetry shifts, tangent to the \DBedit{$N$-dimensional} group orbit $\pS_\ssp$.
    (b)
\DBedit{Each point has a unique trajectory (blue) under time-evolution.}
    (c)
\DBedit{Each point also belongs to a group orbit (green) of symmetry-related points. For \SOn{2}, this is topologically a circle. Note
that two points on a group orbit may lie far from each other in \statesp , but have physically equivalent futures.}
    (d)
\DBedit{Together, time-evolution and group actions trace out a \wurst\ of physically equivalent solutions.}
}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Suppose \edit{your day job} is computing numerically exact invariant solutions
...
section and slice plus time and shift constraints does the job. It is possible to compute 60,000\rpo s this way.\rf{SCD07} Once we have more than one

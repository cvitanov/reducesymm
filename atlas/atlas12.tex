...
even the \wurst\ traced out by
    \ESedit{one of}
the very simplest,
    \ES{2012-04-24}{There's an even simpler $\cycle{1}$-cycle. {\bf
    Predrag:} $\cycle{1}$ is the \reqv\ $\REQV{}{1}$, not a \rpo, right? {\bf KC(2012-04-25)} Agree with ES, there is a simple loop, $\cycle{1}$, it goes around the relative equilibrium (shouldn't this be $\REQV{}{0}$? not $\REQV{}{1}$?)}
short \rpo\

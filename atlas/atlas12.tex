...
Symmetry-reduced \cLf, $d=4 \to 3$~dimensional $\{x_2,y_2,z\}$ projections:
 ...
 The dynamics exhibits singular jumps
 ...
 (d)
The 2-chart atlas (see a sketch of \reffig{fig:A29-1ridge}) of the same
strange attractor encounters no \chartBord s and exhibits no
singularities.
    \PCedit{
The charts are 4\dmn, the ridge 3\dmn, so the the colored blocks and
planes are only cartoon drawings of their projections onto 2 dimensions
of the figure.
    }
The ridge (shown in brown) acts as a \PoincSec\ $\PoincS$ with red or
...
its 2-chart atlas, \reffig{fig:CLf01group}\,(d).
    \PCedit{
The only object that enters the \slice\ hyperplane, border and ridge
conditions is the ray defined by the unit vector $\hat{t}{}^{'}=
\sliceTan{}/\Norm{\sliceTan{}}$. There is much freedom in picking
\template s: the two rays
\bea
...
\label{DanielTmpls2}
\eea
used to construct the depicted \cLe\ 2-chart atlas were found by

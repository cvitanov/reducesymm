...
\maketitle
    ...
    \begin{quotation}
\DBedit{Today, it is possible to take a stroll through the high dimensional
\statesp\ of hydrodynamic turbulence where trajectories are guided by close passes near invariant solutions of the \NSe. Charting these close passes is a geometer's task, and we will map them using a measuring tape, but first one has to deal with complication brought on by symmetries.
The \NSe\ accept symmetric solutions and physicists often seek these out, both for their beauty, as well as for the simplifying assumptions that can be made in calculating them. Turbulence, however, does not exhibit these symmetries, and, thus, the usefulness of employing symmetric solutions to understand it is limited.}
...
the \NSe, finite sets of \reqva\ and infinite hierarchies of \rpo s, and

...
\PCedit{%2nd try, incorporating Evangelos comments
In quantum field theory, the freedom of choosing moving frames shown in
\reffig{fig:BeThMovFr} is called `gauge freedom' and a particular
prescription for choosing a representative from each gauge orbit is
called `gauge fixing'. The corresponding gauge fixing submanifold may not
intersect a gauge orbit, or it may intersect it more than once (`Gribov

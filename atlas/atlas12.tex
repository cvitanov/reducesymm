...
~~(b)
  \begin{picture}(1,0.98742208)%
    ...
    \put(0.6734028,0.35844745){\color[rgb]{0,0,0}\rotatebox{0.0313674}{\makebox(0,0)[lb]{\smash{$\ssp(0)$}}}}%
    \put(0.61182757,0.7462884){\color[rgb]{0,0,0}\rotatebox{0.0313674}{\makebox(0,0)[lb]{\smash{$\sspRed(\zeit)$}}}}%
    \put(0.35738205,0.86652375){\color[rgb]{0,0,0}\rotatebox{0.0313674}{\makebox(0,0)[lb]{\smash{$\LieEl(\zeit)$}}}}%
    \put(0.48490227,0.11640486){\color[rgb]{0,0,0}\rotatebox{0.0313674}{\makebox(0,0)[lb]{\smash{$\sspRed(0)$}}}}%
    \put(0.6547908,0.19892637){\color[rgb]{0,0,0}\rotatebox{0.0313674}{\makebox(0,0)[lb]{\smash{$\LieEl(0)$}}}}%
  \end{picture}%
 \end{center}
...
later.
(b)
Two physically equivalent flows
$\ssp(\zeit)=\LieEl(\zeit)\,\sspRed(\zeit)$ are related, in general, by
an \DBedit{arbitrary , DB:Are these shifts really arbitrary? I would think that they are actually specific for two given points on a group orbit. A single point is related to another non-specific point on its group orbit by arbitrary shifts.} time dependent {\em moving frame} transformation $\LieEl(\zeit)$.(from \wwwcb{}).
  }
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
section \refeq{eq:sspRSing} were \eqva, captured only if the section cut
...
subspaces. For \cLe\ \refeq{eq:CLeR} the invariant subspace is the 1\dmn\
$z$-axis, with trivial dynamics, $z=-bz$, but in general they are
...
that is easier than doing the problem\rf{SCD07} that needs to be solved.
However, the dynamics within an invariant subspace has very little to do,

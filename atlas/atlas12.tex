...
representation, anything else would be sheer masochism. The dynamical theory of
turbulence is still in its infancy, and symmetry reduction is not yet common practice for
numerical simulations and experimental data collection of such nonlinear
systems. We show here how to bring the numerical
/ experimental data to a symmetry-reduced format, \emph{before} any
analysis of it takes place. We strive to explain the key geometrical ideas in simple but illustrative
...
\,.
\ee{innerproduct}
For experimental data, a more natural norm might some distance between
images calculated using the tools of pattern recognition.
...
$z$-axis, with trivial dynamics, $z=-bz$, but in general invariant subspaces are
high-dimensional and have their own dynamics. General relativists and

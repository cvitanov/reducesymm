...
(d)
 ...
 \caption[$\On{2}_\theta \times \SOn{2}_z$ symmetry of flow in a stream-wise
          periodic pipe]{
\DBedit{
Physically equivalent states are related by symmetry: a pipe flow solution translated or rotated is also a solution.}
...
\DBedit{Symmetry-related states may be connected by time evolution:}

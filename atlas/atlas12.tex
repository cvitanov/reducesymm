...
\PCedit{
If a flow has symmetry, the simplest solutions are the highly symmetric
invariant \eqva\ and \reqva\ studied in bifurcation-theory approaches to
the onset of turbulence. Physicists love symmetry,\rf{Kerswell12} but
Nature does not care: turbulence breaks all symmetries, and while the
flow equations may be invariant under $\Group$, their solutions typically
are not. Furthermore, it is not clear whether the highly symmetric
solutions lie anywhere near the regions of \statesp\ explored by
turbulence.}
>>>>>>> .r2778
...
(b)
 ...
 stable eigenvector, with \poincBord\ drawn as the solid red line.  Note the ridge
...
$(61,506\!-\!N)$\dmn\ tiles, or charts. We do it step by step,

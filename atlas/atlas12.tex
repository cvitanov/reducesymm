...
papyrus. \edit{But what about for hydrodynamic flows where the
...
The \chartBord\ ${\cal}$ is the \edit{$(d\!-\!N\!-1)$\dmn\ } hyperplane that contains
...
initial chart $\pSRed{}^{(1)}$ is a \edit{($d\!-\!N$)\dmn\ } hyperplane. If we
pick another {\template} point $\slicep{}^{(2)}$, it comes along with its
own \slice\ hyperplane $\pSRed{}^{(2)}$. Any pair of \edit{$(d\!-\!N)$\dmn\ }
local \slice\ hyperplanes intersects in a {ridge}, a \edit{$(d\!-\!N-\!1)$\dmn\ }
...
symmetries, and (2) tile the reduced \statesp\ with flat \edit{$(d\!-\!N)$\dmn\ } tiles,

...
group orbits in an open neighborhood. Here we have defined an atlus
...
attractor of the \cLe, with the ridge points
$\sspRed^* \in \PoincS$ marked green and purple. The ridge can act as a \PoincSec\ with either green or purple intersecting the chart.
  }
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\statesp s by integrating the associated {reconstruction equations} \refeq{reconstrEq}.

...
and not [...]? a brief tour of the graveyard of obvious ideas\DB{``graveyard of obvious ideas'' rings a little aggressive, no?} and pet symmetry reduction schemes is called for. They all have one thing in
...
baggage at the door\DB{Again, rings a little aggressive} - the way symmetries act on nonlinear systems is much
...
number of these polynomials grows very quickly, as does the number of syzygies,
...
There exist sophisticated approaches to reducing symplectic symmetry in the
mechanics of a three dimensional rigid bodies,\rf{MaWe74} or using Lie

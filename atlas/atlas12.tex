...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
(a)\includegraphics[width=0.24\textwidth]{RoessTrjs2.png}%{Rossler_Equilibria2}{RoessTrjs}%
...
\begin{figure}%[H]
\begin{center}
(a)\includegraphics[width=0.23\textwidth,clip=true]{RoessFarEq3}%
(b)\includegraphics[width=0.23\textwidth,clip=true]{RoessSctAtlas3}
\end{center}

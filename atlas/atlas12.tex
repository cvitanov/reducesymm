...
solutions equivalent under the symmetries of a given flow. \DB{2012-06-15}{Elegant solution Siminos... this section gave us so much crap and you just deleted it! I like dropping it from the lead paragraph but I definitely think that these ideas should be somewhere in the paper. Maybe in the Introduction?}
% ES commented out 2012-06-15: 
% Easiest to
...
Suppose your day job is numerically computing invariant solutions of the \NSe. Do you
...
`gauge fixing'. The corresponding gauge fixing submanifold may not
...
`Gribov horizon'. Within a Gribov region the Faddeev-Popov operator is
strictly positive, while on the Gribov horizon it has at least one
vanishing eigenvalue. The Gribov region is compact and bounded by the
Gribov horizon, a convex manifold in the space of gauge fields.} 
...
region or the Gribov horizon a convex manifold? {\bf DB 2012-06-15:} I agree that all this QFT stuff kind of comes out of left field. Discussing it with Predrag convinced me that it may be interesting to have this here because there appear to be some strong parallels with what we're doing. I may need a little massaging to make it more pallatable, though.}

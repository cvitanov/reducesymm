...
\PCedit{
The dynamical theory of turbulence is still in its infancy, and symmetry
reduction is not yet a common practice in post-processing  turbulence
...
symmetry-reduced format, \emph{before} any analysis of it takes place. We
strive to explain the key geometrical ideas in simple but illustrative
...
\braket{\sspRed^*}{\sliceTan{}{}^{(2)}} = 0
    \,.
\ee{ridge}
Ridge is a \PoincSec\ $\PoincS{}^{(ij)}$ that serves as
...
freedom: It is a local change of coordinate with one (or $N$) coordinates
...
and not [...]? a brief tour of the graveyard of obvious ideas and pet
...
of bifurcations\rf{ruell73,golubII} - linear theory works quite well at a
bifurcation, not so globally.
...
sophisticated  approach would be to rewrite the dynamics in terms of
...
There exist a beautiful theory of symplectic symmetry reduction for the
mechanics of a three dimensional rigid bodies,\rf{MaWe74,AbrMars78} or
...
connections,'\rf{rowley_reduction_2003} illustrated in \reffig{fig:BeThMconnect}.
A group dynamics cousin of the strobing method of \refsect{s:cut},
this approach does not reduce the dynamics to a lower-dimensional \reducedsp\
$\pS/\Group$. In field theory, the freedom of choosing moving frames shown in
...
``gauge.'' The meaning of the ``method of
connections'' in classical dynamics is clearest in the work of Shapere and

...
stable eigenvector (\reffig{fig:RoessNearEq}) of $\slicep{}^{(-)}$, and the
...
two templates (\reffig{fig:RoessBothEq}).
...
{\template} neighborhood (see figures
\reffigs{fig:RoessNearEq}{fig:RoessFarEq}). Beyond the border, the flow
...
\end{center}
  ...
  {\eqv} $\slicep{}^{(-)}$ and its stable eigenvector. The green region
  highlights the chart of the $\slicep{}^{(-)}$ neighborhood.
}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{center}
  ...
  $\slicep{}^{(+)}$  and its unstable eigenvector. The green region highlights
  the chart of the $\slicep{}^{(+)}$ neighborhood.
...
\reffigs{fig:RoessNearEq}{fig:RoessFarEq} are conic sections. The two
...
rate, the section in \reffig{fig:RoessNearEq} is for all practical

...
\reffig{fig:robbins3-7} and hopefully a sensible combined 2-chart atlas
(no one has drown that one), but small in size, and laid out like
\reffig{f:RosslSect}, with sensible $z$-axis.
...
In order to illustrate \PoincBord, we need two charts like
\reffig{fig:robbins3-7} (by Bryce, see robbins3-7.nb), and hopefully the
combined 2-chart figure, but small in size, and laid out like
\reffig{f:RosslSect}, with sensible $z$-axis.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
   \centering
(a)\includegraphics[width=0.20\textwidth]{A27groupTan}
(b)\includegraphics[width=0.20\textwidth]{A28tangents}
...
\begin{figure}
   \centering
(a)\includegraphics[width=0.20\textwidth]{A28mConnect}

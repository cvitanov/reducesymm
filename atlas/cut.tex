...
\end{split}
\eeq
where $a = b = 0.2$ and $c = 5.7$. This flow has two unstable \eqva\
indicated in \reffig{fig:AmLeAg06Im1}.
    \PC{ Draw (un)stable eigenvectors as in
    \reffig{fig:AmLeAg06Im1}. Also, run the unstable spiral(s) for the
    upper brunch further out, to trace out the basin boundary.}

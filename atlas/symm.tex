...
(from \wwwcb{}).
 ...
 \end{figure}
													\toCB
    \PC{
Use \reffig{fig:A27-pipeSymms} in ChaosBook.org and siminos/atlas/atlas.tex.
...
symmetry group $\Gpipe$ contains two commuting \SOn{2} rotations
(\reffig{fig:A27-pipeSymms}). Each
\SOn{2} subgroup group orbit is (topologically) a circle(\reffig{fig:2840GOt135th0}),
...
\begin{figure}
  \includegraphics[width=0.2\textwidth]{A27RoFire}\\
...
popularized by Johnny Cash \etal\rf{CaCaKi63} in 1963 as
``The Ring of Fire'' (\reffig{fig:A27RoFir}).
...
(a)
  \begin{picture}(1,0.95721498)%
    \put(0,0){\includegraphics[width=\unitlength]{A27movFrame}}%

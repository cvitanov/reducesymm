...
What is a symmetry? Fluid dynamics of a pipe flow affords an easy
illustration, \reffig{fig:A27-pipeSymms}.
...
\SOn{2} group orbit is topologically a circle, but it traces out a
...
confined to the group orbit. A {\em \rpo} $\pS_p$ is a trajectory which
exactly recurs
\beq
...
\reffig{fig:A27-pipeSymms} and \cLf\ \reffig{fig:CLf01group}\,(b) are
examples.
...
in \reffig{fig:CLf01group}\,(b) is not so easy to gets one's head around:
...
To summarize, in presence of continuous symmetries, there are two kinds
of motions: dancers, continuously changing shapes, and drifters who
merely shuffle along the easy, shape -non-changing directions. We will
presently get rid of the drifters, and just enjoy the dance.

...
%[BMS]{BMS}
 V. Baladi, S. Marmi, and D. Sauzin\rf{BaMaSa13}
...
%[BCV]{BomCasVar12}
T. Bomfim, A. Castro, and P. Varandas\rf{BoCaVa16}
...
% [CD]{CD}
 F. Contreras and D. Dolgopyat\rf{ConDol16,Contreras14} {\it Regularity of absolutely
...
Lucarini\rf{Lucarini15}'s the longest known title paper
...
\item[2015-10-25 Ben]
Some relevant discussion from Ruelle's review paper\rf{Ruelle09}; 'physical'
...
[It is known since Jakobson\rf{Jakobson81} that many unimodal maps
have...an invariant measure absolutely continuous with respect to
Lebesgue on $[a,b]$.]

%looking back over \ref{Young02} next
...
Now that you have decided to cite Abramov\rf{Abramov14}, you do have to
...
Pollicott and Vytnova\rf{PolVyt16}
{\em Linear response and periodic points}
that refers to my 1998 notes on linear response\rf{CviSon98}. Maybe the

...
\ifboyscout %%%%%%%% DISPLAY COMMENTS AS FOOTNOTES %%%%%%%%%%%%%%%%%%%%
  \renewcommand{\PC}[2]{$\footnotemark\footnotetext{Predrag: #1: #2}$}
  \renewcommand{\BM}[2]{$\footnotemark\footnotetext{Ben #1: #2}$} %date, comment
\fi

...
Macfarlane and Pfeiffer\rf{MacPfe04}
...
MacKay and Taylor\rf{MacTay06a}
...
Westbury's observation\rf{Westbury02} of their uniform spectral 
...
\HREF{https://scholar.google.com/citations?hl=en\&user=Ipic38UAAAAJ\&view_op=list_works\&sortby=pubdate}
{P. Dorey},
A.~Pocklington and  
\HREF{https://scholar.google.com/citations?hl=en\&user=8jQC4bsAAAAJ\&view_op=list_works\&sortby=pubdate}
{R.~Tateo}\rf{Dorey2002a} 
{\em Integrable aspects of the scaling q-state Potts models I:
    Bound states and bootstrap closure}
% {\em Nucl. Phys. B \bf 661},  425  %  425-463
(2003);
...
\item[2026-05-11 Predrag]
Kimyeong Lee and Kaiwen Sun,
{\em 2d Conformal field theories on Magic Triangle},
\arXiv{2601.04162},
has lots of stuff, should study it.

The magic triangle due to Cvitanovi\'c and Deligne--Gross is an extension of the
Freudenthal--Tits magic square of semisimple Lie algebras. We identify
all 2d rational conformal field theories associated to the magic triangle.
We uncover a
two-parameter family of fourth-order modular linear differential equation whose solutions
yield the affine characters of all elements in the magic triangle.
[Keep on reading].


\item[2026-05-11 Bernard Julia] 
I believe many of the ideas were known for a long time and discussed  
for the bottom line of the triangle, but I should look at it more carefully. 
One name that comes to my mind is 
\HREF{https://scholar.google.com/citations?hl=en&user=Ipic38UAAAAJ&view_op=list_works&sortby=pubdate}
{Patrick Dorey}.

\item[2026-03-18 Predrag]
Thomas Creutzig, Niklas Garner, Byeonggi Go and Heeyeon Kim
\emph{W-algebras of the Deligne-Cvitanovi{\'c} Exceptional series and the minimal 3d %=4 
	SCFT},
\arXiv{2603.17394}.

We propose a three-dimensional field theory construction that realizes the vertex algebras associated with the intermediate Lie algebras and the related C2-cofinite minimal W-algebras of the Deligne-Cvitanovi{\'c} (DC) series as boundary algebras. The construction is based on the minimal three-dimensional %=4
 superconformal field theory coupled to a topological field theory. For a Neumann-type boundary condition compatible with the topological A-twist, the algebra of boundary local operators realizes the minimal W-algebra. %W−h∨/6(𝔤,fmin). 
 While this boundary condition is not deformable to the B-twist, we argue that a holomorphic-topological (HTB) twist instead realizes the level-one affine algebras of the intermediate Lie algebras, providing a uniform three-dimensional origin for these vertex algebra structures.
...
\HREF{https://ms.unimelb.edu.au/people/profile?id=606}
...
\begin{enumerate}
  \item 
I like planar graphs\rf{Cvit81planar}, but: why restrict  $E_8$ diagrams to planar?
  \item
...
paper enable you to do that? 
 ...
 Dorey, Pocklington and Tateo\rf{Dorey2002a} 
{\em Integrable aspects of the scaling q-state Potts models I:
...
{\em The trigonometric E8 R-matrix} (2020)\rf{ZinnJustin20}, 
\\
\arXiv{2004.02044},
...
\item[2024-06-03 Westbury] and Zinn-Justin % \rf{WesZin24}
{\em A uniform trigonometric R-matrix for the exceptional series} (2024),
\arXiv{2406.01348},\\ 
extended 8-page abstract \wwwcb{/library/WesZin24abs.pdf};

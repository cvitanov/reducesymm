...
\item[2026-05-29 Predrag]
\HREF{https://durham-repository.worktribe.com/person/855171/christopher-marcotte}
{Chris Marcotte} , \HREF{https://github.com/cmarcotte}{(gitHub)},  student has a birdtracks drawing  open source \HREF{https://typst.app/} {typst} plugin \HREF{https://github.com/m-pluta/birdtracks} {gitHub.com/m-pluta/birdtracks}. It doesn’t include any precompiled outputs, but Chris will ask the student if he’s happy for me to share his report.

\texttt{typst} is a versatile and powerful typsetter, maybe a future replacement for \texttt{TeX}, 
but as \texttt{typst}$\;\Longleftrightarrow\;$\texttt{TeX} conversions are not straightforward, 
I'll stick to \texttt{LaTeX}.
...
\item[2025-08-13 Predrag]
Cougoulic and Peign{\'{e}} %\rf{CouPei25}
$27\bigotimes27$,
\arXiv{2504.11362}.

the decomposition into irreps of the
tensor product $27\bigotimes27$, where $27$is the highest-dimensional irrep present in a
two-gluon system, and construct all Hermitian projectors on
these irreps, as well as transition operators between them. This yields
an explicit basis of the complete \SUn{N}\ color space
in terms of orthogonal multiplets. [...] we
eigenspaces allow efficient filtering of all projectors and transition
operators, and of the permutation operators that further improve this
filtering. [...]
...
\item[2024-11-16 Predrag] email:
Dear Stephen and Athis

Thank you for referencing my Phys. Rev. D14, 1536 (1976) paper. I had
published other papers on color space, in particular Nucl. Phys. B186,
165 (1981),  but in the context of your paper, if you want to reference
only one source, I think https://birdtracks.eu is probably the most
useful reference for our community.

I expect the SO(N) and Sp(N) numbers to be the same, by the negative
dimensions relations explained in the book, but wow, 17 independent null
vectors! That you see only at 5-loops, or higher?
I never went that far, very nice. I do not recommend following
my path, unless experiments force you to :), but the book came out of my
studies of gauge theory color space constraints also for exceptional Lie
groups.
...
Naculich and Osathapan\rf{NacOsa24} {\em All-loop group-theory
constraints for four-point amplitudes of {SU(N), SO(N), and Sp(N)} gauge
theories}; % (2024);
\arXiv{2407.03403}.

No birdtracks (paper would profit from them), but in the spirit of my
original motivation for studying color space.

"In the decomposition of gauge-theory amplitudes into kinematic and color
factors, the color factors (at a given loop order L) span a proper
subspace of the extended trace space (which consists of single and
multiple traces of generators of the gauge group, graded by powers of N).
[...] we construct the L-loop color space of four-point amplitudes of
fields in the adjoint representation of SU(N), SO(N), or Sp(N). We define
the null space as the orthogonal complement of the color space. For
SU(N), we confirm the existence of four independent null vectors, and for
SO(N) and Sp(N), we establish the existence of seventeen independent null
vectors. Each null vector corresponds to a group-theory constraint on the
color-ordered amplitudes of the gauge theory."

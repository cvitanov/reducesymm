...
\item[2016-12-03 Predrag]
Reading Shimizu and Tachikawa\rf{ShiTac16}, in particular the footnote $^1$.
...
\arXiv{math/9910059}
\\~[PS now arXiv includes blog links:
...
The full list of omissions by Berger, including \reftab{Bryant99tabIV},
referred to as the {\it exotic list\/}, was compiled by a
Chi, Merkulov, Schwachh\"ofer, and Bryant\rf{ChMeSc96,Bryant87,Bryant91}.

For the first two examples from \reftab{Bryant99tabIV}, each torsion-free
connection of these types was analyzed in \refref{Berger57}.   The
construction involved a number of seemingly miraculous identities.
Chi, Merkulov, and Schwachh\"ofer\rf{ChMeSc96} found other exotic symplectic
examples,noticed that the reconstruction technique generalized, and explained
it in the context of Poisson geometry in a very beautiful way.

Even for the exceptional holonomies, there are explicit examples of
cohomogeneity one\rf{Bryant87,BrySal89}.

It was the study of the moduli space of rational
curves on a complex surface with normal bundle~${\cal O}(3)$ that
turned up the first two entries in
\reftab{Bryant99tabIV}) of omissions from Berger's nonmetric list\rf{Bryant91}.
These examples were referred to as `exotic' in \refref{Bryant91} and the term
has been adopted to describe any nonmetric subgroup~$H\subset\GL({\mathfrak
m})$ that satisfies Berger's criteria but that does not appear on Berger's
original nonmetric list.

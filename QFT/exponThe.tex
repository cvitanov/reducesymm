...
\vev{W}_R = \frac{1}{d_R}\vev{\tr\, e^{2\pi M}}=
 \frac{1}{d_R} \frac{
    \int_{\mathfrak{g}}dM\,\tr\,e^{2\pi M}\,e^{-\frac{2\pi^2}{g\tr\,M^2}}
                    }{
    \int_{\mathfrak{g}}dM\,e^{-\frac{2\pi^2}{g}\tr\,M^2}
                     }
\,,
\ee{winmm}
...
For \Un{1} of (quenched) QED, the Lie algebra is one\dmn, all
...
representations of \SUn{n}, and makes irreps selfdual udnder Young diagram
...
FormTracer\rf{CyMiSt16}. These expressions are not pretty, but
...
exponentiation theorem\rf{Gatheral83,FreTay84}.
...
\emph{chord diagrams}\rf{Touchard52}. At order $2n$ there are $(2n-1)!!$
...
defined as follows\rf{Bouchet94}:

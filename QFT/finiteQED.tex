...
\reffig{Laporta17figuragauShort}? My hunch is that the gauge set (6) = $(4,0,0)$ would be
...
from \refref{Cvit77b}. For the updated listing, see
\reftab{tabGaugeSets}.
}
 \end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
closed electron loops (see \reffig{Laporta17figuragauShort})

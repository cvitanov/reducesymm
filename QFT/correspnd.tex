...
You can use the \arXiv{1905.08007}, \refref{Volkov19}, for my 5-loop QED results with gauge-invariant classes:
to quote my results, see

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{table}
\begin{center}
\includegraphics[width=0.80\textwidth]{Volkov19Tab1}
\end{center}
\caption{\label{Volkov19Tab1}
Contributions of the gauge-invariant classes (k,m, n) to quenched QED A(10.
Volkov\refref{Volkov19} Table~1.
}
\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

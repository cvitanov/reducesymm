...
All errors go from right to left (the same direction)

Repeated most of S. Keppeler and M. Sjodahl who used iterative methods,
see
\rf{AlcZei16-3} bottom p.~18
...
J. Alcock-Zeilinger and H. Weigert\rf{AlcZei16-1}
{\em Simplification rules for birdtrack operators}
...
J. Alcock-Zeilinger and H. Weigert\rf{AlcZei16-3}
{\em Compact {Hermitian Young} projection operators}
...
should be third paper

J. Alcock-Zeilinger and H. Weigert\rf{AlcZei16-2}
{\em Transition operators}

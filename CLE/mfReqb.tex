...
~~~~(\textit{b})\includegraphics[width=0.35\textwidth,clip=true]{CLEperpReqb}
\end{center}
\caption{
...
\ee{cLeMFsingElim}
We plot the projection of \sset\ in $3$-dimensions $(x_1,x_2,y_1)$ in \reffig{fig:CLEmfsset}(a)
\ES{Axes are wrong in figure, I'll fix this.
	}.
We observe the attractor meet the \sset\ head on and become deformed. 

Linear relation \refeq{cLeMFsingElim} and \reffig{fig:CLEmfsset} suggest that we can manipulate the \sset\ 

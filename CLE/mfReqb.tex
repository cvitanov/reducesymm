...
\reffig{fig:CLEmfDali}(b), \reffig{fig:CLEmfAdHoc}.
    ...
    \PC{OK, plagiarize. But why twice? I see no difference between
        CLEmfReqb123.eps and CLEmfAdHoc123.eps
       }
    \ES{Not sure who I plagiarize, but anyway you are right that
	this projection is not helpful. I've updated figure \reffig{fig:CLEmfAdHoc}
	to compare $(x_1,y_1,z)$ projection with the two different choices.
	Im not sure that the plot of the singular set is accurate in this 

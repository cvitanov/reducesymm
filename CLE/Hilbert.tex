...
system\rf{ZeMa85}, conjugate to \cLe, with $e=-\ImrCLor$.
...
\begin{figure}[ht]
\begin{center}
  (\textit{a})\includegraphics[width=0.35\textwidth]{CLEip1}
...
We use the chain rule \refeq{HilbChainRl}, \refeq{eq:ipLaser} and \refeq{eq:CLeR}
%\beq

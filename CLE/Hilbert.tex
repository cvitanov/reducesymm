...
near the $z$-axis, since invariant polynomials are multiplicative
...
Following \refref{Christiansen97} we construct the first return map using as coordinate the
...
% This is likely
% to happen if there is only one unstable direction,
% as we saw in the R\"ossler attractor
% \refexam{exam:RosslerRetMap}, but if
% there are several, the `{\turn}' might get stretched out in
% the non-leading expanding directions.
% \index{turnback point}

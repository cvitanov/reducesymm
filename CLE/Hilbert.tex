...
% ~~~~(\textit{b})\includegraphics[width=0.36\textwidth,clip=true]{CLEip2}
\end{center}
\caption{
...
\ie, the invariant, Hilbert polynomial coordinates $u_i$, as in
...
of \reffig{fig:CLEipRM} using as a coordinate the
...
\begin{figure}[ht]
\begin{center}
%   (\textit{a})\includegraphics[width=0.35\textwidth,clip=true]{CLEipRMu1}
%  ~~~~(\textit{b})
\includegraphics[width=0.35\textwidth,clip=true]{CLEipRM}
\end{center}
\caption{
The return map \JFGedit{for} the \Poincare\ surface of section $u_1=u_4$ for

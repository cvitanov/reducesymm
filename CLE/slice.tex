...
to the \emph{method of slices} introduced in the context of Kahrunen-Lo\'eve
...
at least locally, write the full \statesp\
...
is not adequate for our purposes as it suffers from the so-called \emph{geometric
phase}.
% \PublicPrivate{}{
% % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

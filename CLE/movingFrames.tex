...
\beq
  \theta=\tan^{-1}\frac{-\slicepComp{x}{1}x_2+\slicepComp{y}{2}y_1-\slicepComp{y}{1}y_2}{\slicepComp{x}{1}x_1+\slicepComp{y}{1}y_1+\slicepComp{y}{2}y_2}\,.
\ee{cLeMF}

...
and slice condition \refeq{PCsectQ1} leads to
    ...
    to fix the slice. Was I wrong? {\bf ES}: It's a matter of taste. If you rescale
    ...
    three numbers. I think you were wrong concerning dimension of singular subspace
...
\ES{Predrag dropped this but I am not sure: ``In general, when a \slice\ $\pSRed$ is defined through

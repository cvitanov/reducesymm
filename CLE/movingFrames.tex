...
\begin{center}
(\textit{a})\includegraphics[width=0.43\textwidth]{ReducTraj1}
~~~~(\textit{b})\includegraphics[width=0.43\textwidth]{ESunrot}
\end{center}
\caption{
(a)
...
We illustrate this point in \cLf\ example in \refsect{sec:CLeMovFr}.
...
in the $a-b$ plane.
\ES{dropped: so that \refeq{cLeMF}, when substituted back to representation \refeq{CLfRots} of \SOn{2}
results to the correct geometric operation of mapping points back to the slice.
Therefore the range of $\tan^{-1}$ here is $-\pi<\theta\leq\pi$.}
...
as we did in Hilbert basis case.\ES{In thesis and here Hilbert
...
\begin{figure}[ht]
\begin{center}
  (\textit{a})\includegraphics[width=0.35\textwidth]{CLEmfXYZ}
~~~~(\textit{b})\includegraphics[width=0.35\textwidth]{CLEmfYYZ}
\end{center}
\caption{
...
\begin{figure}[ht]
\begin{center}
  (\textit{a})\includegraphics[width=0.35\textwidth]{CLEinvXYZ}
~~~~(\textit{b})\includegraphics[width=0.35\textwidth]{CLEinvYYZ}
\end{center}
\caption{
\Statesp\ portraits of \cLe\ dynamics  in \reducedsp,
...
\begin{figure}[ht]
\begin{center}
%   (\textit{a})\includegraphics[width=0.35\textwidth]{CLEinvRMx2}
%  ~~~~(\textit{b})

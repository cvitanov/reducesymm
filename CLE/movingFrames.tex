...
We can impose an orientation condition, for example 
\ES{I was wrong, this would only work in the piecewise integration approach, will only mention it there:
choosing the angle that
results in the smallest counter-clockwise rotation.
	} 
...
\ES{Predrag dropped this but I am not sure: ``In general,
...
\\
{\bf PC:} If we are using them only in this example, why bring them in?
Seems like a special case of a linear slice.
}

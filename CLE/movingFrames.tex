...
We can, at least locally, map each point along any solution
$\ssp(\tau)$ to the unique representative $\sspRed(\tau)$ of the associated
...
In the `\mslices' the \reducedsp\ representative $\sspRed$
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
We start by describing how the
method works for a finite segment of the full \statesp\
trajectory.


\ES{obsolete, to be re-eject later: In this section we present the {\mframes}, introduced by G. Darboux and 
...
\refeq{PSPlane} for group orbits.
...
\,,
\ee{EquiTrajInvrs}
that is passing to a frame of reference in which condition
\refeq{PCsectQ1} is identically satisfied, see
\refexam{exam:SO2movFram}. Therefore the name `moving frame.'

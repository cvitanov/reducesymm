...
\begin{split}
	...
	\dot{r}_2 &=-r_2 + r_1(\RerCLor -z)(\cos\phi-\rho_2\sin\phi) \cont
	\dot{z} &=  -b z+r_1 r_2\cos\phi \cont	
	\dot{\phi} &=-e-\frac{\sigma r_2 \sin\phi}{r_1}-\frac{r_1(\RerCLor-z) (\rho_2\cos\phi+\sin\phi) }{r_2}\,,
	\label{eq:CLePolar}
\end{split}
\eeq
...
\begin{split}
	...
	\dot{\phi_2} &= e +\frac{r_1\left( (\RerCLor -z)\sin\phi+\rho_2\cos\phi\right)}{r_2}\,.
	\label{eq:CLeAngl}
\end{split}
\eeq

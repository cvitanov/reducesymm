...
Even though the computation of invariants with the 
...
how one can use the geometric interpretation of the {\mframes} along
...
by the {\mframes} are singular in the subspace
$x_1=x_2=0$.

...
by \refeq{cLeCoordTheta}. As we remarked in \refsect{s:mfReqb}
this rotation, a linear operation for any given point, can be applied efficiently
even in a high dimensional space.\ES{Restore and refer to return map of coordinate slice section.}

...
% $Author: predrag $ $Date: 2009-04-17 11:40:25 -0400 (Fri, 17 Apr 2009) $
...
The stratification\ES{define?: stratum} of $\Manif$ induced by the group action is carried over to the quotient space with each disconnected set in a stratum mapped to the same manifold in quotient space.
...
of the symmetry group (\cf \refref{gatermannHab,ChossLaut00} for a discussion of methods) and either rewrites
...
\end{split}
\eeq
The polynomials in a Hilbert basis are linearly independent, but often functionally dependent through
...
singularities at the \fixedsp s\ES{define: \fixedsp} of the isotropy subgroups in

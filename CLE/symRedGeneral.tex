...
typical computations are confined to dimensions smaller than
ten. As our goal is to quotient continuous symmetries of
high-dimensional flows (high = $10^2$-$10^6$ coupled ODEs),
such as those arising from truncations of the \KS\ and
Navier-Stokes flows, the Hilbert basis at present are not a
feasible option.

Nevertheless, symmetry reduction of moderate-dimension flows
by the method invariant polynomials offers an interesting
benchmark for other approaches symmetry-reduction, so we
start by showing how it works of \cLf.

...
with the work of Rowley and Marsden\rf{rowley_reconstruction_2000}.

If a Lie group $\Group$ acts
...
the group orbits.
    \PC{
    Incorporate here text from the
    dasbuch/book/chapters/continuous.tex remarks.
    }
    \ES{Is this {\csection} related to a cross-section in a
    $\Group$-bundle? In other words, can we interpret the
    latter as a submanifold in total space \tSp\ of a
    $\Group$-bundle $(\tSp,\pi,\tSp/\Group)$?
    }

...
The action of a symmetry group \Group\ on \pS\ endows
the \statesp\ with the structure of a union of group orbits,
 each group orbit an
equivalence class. 
\ES{Stratification has different technical meaning in this setting, replaced statement
trying to disturb the poem as little as possible: 
The action of a symmetry group \Group\ on \pS\ stratifies
the \statesp\ into a set of group orbits,
 each group orbit an
equivalence class. 
}
\ES{Alternative very restrictive statement with different meaning, will not use: Group orbits 
of a symmetry group \Group\ acting regularly
on \pS\ foliate the \statesp, each group orbit being
an equivalence class.  
}
The goal of {\em symmetry reduction} is the
...
\JFGedit{The} symmetry group \Group\ of equivariant dynamics acts trivially
in \JFGedit{the} reduced space, and the resulting dynamical system, called
by Gilmore and Lettelier\rf{GL-Gil07b} the \emph{image}, is
symmetry {\em invariant}, in the sense that its symmetry group is
the identity.
The mapping \JFGedit{of}  equivariant dynamics to invariant dynamics is
implemented
by methods such as
{\em \mframes},
...
reduction \JFGedit{was} elegantly solved nearly a century ago.
...
$\cdots$) \JFGedit{that are} invariant under a given set of symmetries. Given a
...
\,.
\ee{HilbWeyl}
\JFGedit{The} Gilmore and Lettelier monograph\rf{GL-Gil07b} offers
...
Navier-Stokes flows, \JFGedit{Hilbert basis reduction} is 

...
drawbacks of different symmetry reduction \JFGedit{methods}. In
...
efficient method \JFGedit{that goes back to Cartan for computing} 
...
are local, and \JFGedit{more than one slice might be needed} to

...
system of ODEs, the \CLe\ reviewed in \refsect{s:introCLE}.

In \refsect{sec:mf} we review the \emph{moving frame method}, a very direct and efficient method to compute 
symmetry invariant bases due to, in the formulation followed here, Fels and Olver\rf{FelsOlver98,FelsOlver99}.

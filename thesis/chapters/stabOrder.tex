...
Let $M(\stabCutoff)$\ES{Changed $M(\ln \stabCutoff)$ and $h(\ln \stabCutoff)$ 
to $M(\stabCutoff)$ and $h(\stabCutoff)$ respectivelly.} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ES{I didn't
expect so wild fluctuation in this plot. ``At
least they are all on the same plane.'' I'm checking my numerics again. Eventhough
it's a simple algorithm there are many loops so there is room for error.}

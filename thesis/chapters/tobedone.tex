...
Having identified in \refchap{chap:kseStSp} the unstable manifolds that are most likely to provide
a coarse organization the \KS\ $L=22$ attractor, the obvious next step is to identify
suitable Poincar\'e sections for their study. Contrary to the \CLe\ example of \refchap{chap:lasers}

...
\KS\ orbits in \refsect{sec:kseStSp}. A different approach
that does not need auxiliary conditions is given in 
\refref{SCD07}, and yet another one that is designed
...
is \refref{DasBuch}. The multiple-shooting method
presented here draws in formulation of the auxiliary
conditions from \refref{Visw07b}.

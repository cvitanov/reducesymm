...
\KSe, which have both discrete and continuous
...
group-theoretical jargon to blind you with.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\FIG{{
(a)~\includegraphics[width=0.48\textwidth]{../figs/lorenz2Poinc}
(b)~\raisebox{1.0ex}{
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\FIG{
(a)  \includegraphics[width=0.36\textwidth]{../figs/lorenzPolarManifDetail1}  %.png}
(b)  \includegraphics[width=0.56\textwidth]{../figs/lorenzSaddle0}  %.png}
...
\FIG{
(a)~\raisebox{7.4ex}{
    \includegraphics[width=0.40\textwidth]{../figs/lorenzPolar1}
    }
~(b)~\includegraphics[width=0.40\textwidth]{../Fig/lorenzPolarPoinc2}
...
\FIG{
(a)\includegraphics[width=0.41\textwidth]{../Fig/plorenz_psec}%
~~%
(b)\raisebox{0.4ex}{
    \includegraphics[width=0.43\textwidth]{../Fig/plorenz_retmap2}
                   }

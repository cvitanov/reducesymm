...
$\EQV{0}$. The dynamics on the sections appear very singular. We explain
...
\section{Stability of Lorenz flow \eqva\label{exmp:LorenzStab}}
For the  Lorenz
...
\index{Lorenz flow}
(continued from \refexam{exmp:LorLinrz}.)~~
...
\section{Lorenz flow \statesp\ contraction\label{exmp:LorenzContr}}
\index{Lorenz flow}
(continued from \refexam{exmp:LorenzStab}.)~~
It follows from \refeq{LorLinrz} and \refeq{traceA} that
...
\subsection{From $d$-dimensional flows to 1-dimensional maps\label{sec:retMaps}}

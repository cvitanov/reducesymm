...
$G$-invariant}, see \refsect{exmp:3dPolyDscr}. In this
...
\subsection{Lorenz equation}{ \label{rem:Lorenz}
% Predrag                           20jan2008
...
%\hfill (continued in \refrem{rem:LorenzSymm}.)
    } %end \subsection{Lorenz equation:}{ \label{rem:Lorenz}

\subsection{H\'enon, Lozi maps}{
...
\index{Misiurewicz, M.}
\index{Young, L.-S.}
} %end \subsection{H\'enon map?}{

\subsection{\protect Grasshoppers {\em vs.} butterflies}{%
...
%
\subsection{Symmetries of the Lorenz equation}\label{rem:LorenzSymm}
...
\subsection{Examples of systems with discrete symmetries}
One has
...
\subsection{A brief history of relativity}\label{cont:rpoCond}
...
\subsection{Surveys of rigorous theory}\label{rem:rig-z}

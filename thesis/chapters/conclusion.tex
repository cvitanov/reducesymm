...
\ES{Dropped: Returning to the description of the dynamicist's view of turbulence we note that if we are to
...
does.}
% Mention applications of moving coframes to vision recognition here?
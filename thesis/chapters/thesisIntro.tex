...
demonstrated our method in the example of KSe but it completely
general and applicable in any other PDE. Application to
Navier-Stokes is left as an exercise to the reader.}. We will
...
to remind us that we deal with a spatially extended system. In \refchap{chap:KSe} we review \KS\ equation in detail
and in \refchap{chap:kseStSp} we study it's \statesp, through \eqva, traveling waves, heteroclinic connections
and \rpo s, for a specific ``box'' size. In \refchap{chap:POT} we attempt to
organize a set of $20000$ \rpo s, provided by Ruslan L.
Davidchack \rf{Davidchack_priv}, by their stability and use

...
translation.
They were already \PCedit{noted} by Poincar\'e in his study of the
...
flow\rf{Visw07b}. A \PCedit{pretty} recent application of \rpo s has
...
of key ideas than the \PCedit{technically much more demanding Navier-Stokes equations}. Yet,
\PCedit{following the above cited imaginary paper}, we emphasize that we develop methods in

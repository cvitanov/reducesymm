...
without any claim that what we deal with is fluid turbulence but with the purpose of 
underlining the relation to other flows with coherent structures.}
% We will concentrate on a system size for which the dynamics are chaot tic

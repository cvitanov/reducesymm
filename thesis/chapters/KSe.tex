...
more convenient, both computationaly and theoreticaly, to work with periodic boundary conditions
\beq
  u(x,t) = u(x+L,t)\,.
 \label{eq:KSper}
\eeq
...
\ES{Discuss antisymmetric subspace as well: or restricted to the subspace of odd functions by
\beq
  u(0,t) = u(L,t)=0\,.
 \label{eq:KSper}
\eeq
...
\ES{Use later on: As $\dot{a}_0=0$ in
...
\On{2} equivariance makes it convenient to work in the Fourier space,
\beq
...
Indeed, the translation operator action on the Fourier coefficients \refeq{eq:ksexp},
...
\,.
\ee{FModInvSymm}
The reader should observe that this action is similar to the action \refneq{eq:O2stndrd} of \On{2} studied
in \refsect{sec:strata}, apart from the minus sign in \refeq{FModInvSymm}. The subgroup lattice remains unchanged but \fixedsp s of the dihedral subgroups are affected. We will discuss the isotropy lattice after we

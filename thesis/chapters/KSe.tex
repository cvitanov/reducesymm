...
% translations.
\ESedit{Unfortunately such a visualization does not contribute to
...
our system size they identify two \rpo\ branches. For larger
systems they also note the existence of partially hyperbolic
invariant tori, see \refchap{chap:tobedone}.
...
these coordinates. \ESedit{ In some sense they are a crude way to implement
symmetry reduction and their utility, as we will see in \refsect{sec:energyL22},
will be limited.}

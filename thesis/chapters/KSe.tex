...
Therefore there is a unique solution branch of equilibria in \Fix{\Dn{1}}, \ie\ with symmetry $\Dn{1}$.
...
\refeq{expan}. The unimodal equilibrium is stable at bifurcation. Under the action of $\Shift$ we

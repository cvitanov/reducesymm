...
in \refsect{sec:strata}, apart from the minus sign in \refeq{FModInvSymm}. The isotropy lattice remains the same but the \fixedsp  of \Dn{m} is now given by the condition
\bea
	z_k=0\ \mathrm{unless}\ k = m j\,,\ j=1,\ldots\lfloor n/m \rfloor \\
	Re(z_k)=0\ \mathrm{for}\ k=1,\ldots,n\,.
	\label{eq:O2ksDqFix}
\eea

...
For $L<2\pi$\ES{Bif. condition: \tildeL=k}
the origin is linearly stable and due to the hyperviscous damping $u_{xxxx}$ it is the global
attractor\ES{reference? Lan's thesis enough?}. At $L=2\pi$ the origin loses stability and due
...
axial subgroup since \Fix{\Dn{1}} is the imaginary axis in the complex $a_1$ plane. 

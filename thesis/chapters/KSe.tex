...
an equilibrium. From commutation relation \refneq{eq:LrzCommut} we conclude that $A(0)$ 
...
with eigenvalues $\lambda_0^{(k)}=( q_k^2 - q_k^4 )$, from \refneq{expan}.
For $L<2\pi$
...
absolutely irreducibly, $v_1(a)$ is equivariant (Liapunov-Schmidt expansion respects symmetry), 
...
\refneq{expan}. The unimodal equilibrium is stable at bifurcation.

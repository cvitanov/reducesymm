...
\ESedit{It is interesting to observe that \rpo s with periods
$\period{p}=34.64,35.97,47.64$ that are controlled by the unstable manifolds of both $\REQV{\pm}{1}$
and $\EQV{2}$ have two positive Floquet exponents\ES{add table} and
associated expanding eigendirections. 
On the contrary \rpo\ with $\period{p}=40.14$ that only visits\ES{Not

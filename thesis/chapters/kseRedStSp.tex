...
The first few fundamental invariants for the action \refeq{eq:shiftF} of $\SOn{2}\subset\On{2}$ on the phase space of \KSe\ have been tabulated in \reftab{tab:SO2n6}. The obvious singularity at $b_1=c_1=0$ can be

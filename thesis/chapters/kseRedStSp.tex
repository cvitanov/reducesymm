...
\beq
	...
	\label{eq:SO2stand}
\eeq
where, as noted in \refchap{chap:lasers}, $\tan^{-1}$ distinguishes quadrants.
...
{First $11$ fundamental invariants for the standard action
 \refneq{eq:SO2stand} of \SOn{2} on \Rls{2N}.}
\scriptsize
\[
\begin{array}{ll}
...
\ESedit{One has to note that the cross-section does not 
exist when $b_1=c_1=0$, as there the group
action fails to be regular when restricted on the $k=1$-irreducible subspace.}
...
carried out by
%\PCedit dropped this: Mathematica
...
\reffigTofig{fig:TW1red}{fig:TW1-E2red}\ES{Sophia says: Do not scrible-scrable!}.
...
the \rpo s.
\ES{\ESedit{dropped:} The same is true for the trajectories originating in the

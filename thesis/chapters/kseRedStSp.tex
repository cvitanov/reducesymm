...
of $\SOn{2}$ in Fourier space of \KS\ equation. The simplifications of expresions were performed using computer algebra system Mathematica. Computation of $255$ invariants for $n=128$ took approximately $20$ minutes on a typical processor.
...
{First $11$ fundamental invariants for the standard action \refneq{eq:SO2stand} of \SOn{2} on \Rls{n}}
\label{tab:SO2n6}
\end{table}
...
after we define suitable Poincare sections.
...
\end{center}
\caption[KSe SO(2) reduced \statesp\ with modified invariants.]
...
of \REQV{\pm}{1} potentialy plays an important role in organizing the flow, a situation
...
the dynamics to descrete time maps on suitable Poincar\'e sections,
...
\begin{figure}[t]
\begin{center}
  (\textit{a})\includegraphics[width=0.35\textwidth]{../figs/ksSO2inv134}
~~~~(\textit{b})\includegraphics[width=0.35\textwidth]{../figs/ksSO2inv145}
\end{center}
\caption[KSe SO(2) reduced \statesp\ projection II]

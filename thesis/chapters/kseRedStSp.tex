...
\RLD{Since $r$ is defined as the sum of squares, I think that $r_1$ in the denominator should be replaced with $r^{1/2}$.  So, it should be $r$ instead of $r^2$ in $u_3$ and $u_4$, $r^{3/2}$ instead of $r^3$ in $u_5$ and $u_6$, etc.}

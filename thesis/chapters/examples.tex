...
Lorenz, \refref{lorenz1}, introduced his celebrated equations as a severe truncation of the Navier-Stokes equations
...
Armbruster, Guckenheimer and Holmes, \refref{AGHO288}, introduced a simple system with $\Og{2}$ symmetry:
\index{Armbruster-Guckenheimer-Holmes system}
\beq
\begin{split}

...
authors knowledge, can be found in
Christiansen~\etal\rf{Christiansen97}. They study \KS\
equation, a dissipative PDE in one spatial dimension as one of
the simplest systems that exhibits features reminiscent of
fluid turbulence, \cf \refchap{chap:KSe} for details. The
``regular'' solutions in Hopf's picture were realized as the
set of all periodic orbits, embedded into the attractor and
ordered hierarchically. Shorter orbits provided the basic
building elements of the attractor, while longer ones
contributed corrections. The quantitative framework within
which those periodic orbits were used to approximate the
natural measure and calculate ``observable'' quantities, such
as Lyapunov exponents and escape rates, was that of periodic
orbit theory\rf{DasBuch}, see \refchap{chap:POT}. The same
approach has been carried out for a ``more turbulent'' \KS\
system in \refrefs{LanThesis,lanCvit07}.
...
specific boundary conditions, with equilibria, traveling waves
...
% We prepare for two future generalizations: invariant tori -
% ``larger'' symmetries.

...
\beq
	...
	\label{eq:Gorder}
\eeq
for some representatives $H_i,\,K_j$.
...
to the other two verteces $B$ and $C$, respectively. Thus all vertices belong to the same group orbit and have conjugate isotropy subgroups, from \refLem{lem:stabGorbit}. Under $\Refl$ vertex $A$ remains fixed. Thus the isotropy subgroup of point $A$ is $\stab{A}=\Zn{2}(\Refl)$. By
...
\begin{figure}
    % \vspace*{-5pt}
\begin{center}
  (\textit{a})\includegraphics[width=0.21\textwidth]{../figs/D3lattice}
~~~~(\textit{b})\includegraphics[width=0.1\textwidth]{../figs/D3stablattice}
\end{center}
\caption[D3 lattices]{
    {\small

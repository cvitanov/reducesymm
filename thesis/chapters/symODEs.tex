...
\[
	\Rot{\pi}(x,y,z) = (-x,-y,z)\,.
\]
Note that this transformation can be considered as either as rotation by $\pi$ around the $z$ axis (hence the
...
a disjoint union of strata which are in an $1-1$ correspondence to the group orbit types. Note that in general
...
of \CLe. Choose coordinates $x_1,x_2,y_1,y_2,z$ on $\Rls{5}$, related t0 the complex coordinates

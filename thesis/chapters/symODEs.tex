...
$\Gamma=\Zn{2}\cong\Dn{1}$ acting on \Rls{3} by
\[
	\Refl(x,y,z) = (-x,-y,z)
\]
\ie~ by rotation by $\pi$ about the $z$ axis.

% As another example the vector field in \CLe is equivariant under the group \SO{2} acting on $\Rls{5}\cong \Clx{2}\times \Rls{}$
% by
% \[
%  
% \]

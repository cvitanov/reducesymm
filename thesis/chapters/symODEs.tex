...
we will concentrate on subgroups $\Gamma\subseteq\On{n}$ in the following.
    \PC{Aren't you supposed to define Lie group, algebra in this chapter?
        ...
        ${\tt Lg} = \mathfrak{a}$ or $\Lg$ would make more sense. Are you
...
$\vf$ commutes with all $\gamma\in\Gamma$ we say that $\vf$
is $\Gamma$-equivariant. The finite time flow
...
\ES{Discuss restriction in form of $A(x)$, eigenvectors.}
...
\ES{Is this {\csection} related to a cross-section in a $\Gamma$-bundle?

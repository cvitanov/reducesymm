...
\end{definition}
\ES{I copy Golubitsky and Stewart's definition here because I am somewhat confused. Are the conjugacy classes of subgroups distinct
from the classes defined by elements of the group? For instance in the example of \Dn{3} bellow, $\Zn{2}(\Refl)$, $\Zn{2}(\Refl \Drot)$ 

...
On the other hand \Fix{\Cn{q}} is invariant under the action of $\Rot{\theta}$.
\ES{Try to understand why $SO(2)$ leaves \Fix{\Cn{m}} but not \Fix{\Dn{m}} invariant
without reference to its representation.}

From \refPro{pro:dimOrb} all group orbits of points $x\in\Rls{n}\setminus\{0\}$ are $1$-dimensional.
Thus \On{2} acts regurarly and locally freely (all isotropy subgroups are discrete) on $\Rls{n}\setminus\{0\}$

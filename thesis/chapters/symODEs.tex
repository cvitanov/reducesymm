...
For the \fixedsp\ of \Dn{q} we have condition \refneq{eq:O2CqFix} and additionally that
\beq
...
\begin{example}
 The actions \refneq{eq:SO2act} of \SOn{2} and \refneq{eq:O2stndrd} of \On{2} are both faithful.
\end{example}
...
The reader is referred to the book of Gilmore and Lettelier \cite{GL-Gil07b} for a very detailed discussion of symmetry reduction. For the action \refneq{eq:SO2act} of $\SOn{2}$ on \Rls{5} a Hilbert
...
\refneq{eq:SO2act} of $\SOn{2}$ as follows. We write out

...
\beq
\begin{split}
	\overline{x}_2 &= x_1^2+x_2^2 \cont
	\overline{x}_2 &= y_1^2+y_2^2 \cont
	\overline{y}_1 &= x_1 y_2-x_2 y_1\cont
	\overline{y}_2 &= x_1 y_1+x_2 y_2\,.
	\label{eq:ipLaser}
\end{split}
\eeq
...
To project dynamics on \reducedsp\ use a slight variation of \refneq{eq:invLaser}:
\beq
\begin{split}
...
\end{split}
\eeq
that lacks a geometric interpretation but produces much cleaner phase portraits\ES{I'll explain why
and give examples using \refneq{eq:invLaser} tommorow. It should rather obvious though.}.

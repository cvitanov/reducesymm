...
Krupa\rf{Krupa90} that one gets bifurcation
to periodic orbits. \PCedit{A secondary bifurcation has been
...
\PCedit{precisely for its symmetry properties} we will concentrate in the
...
\end{center}
\caption[Return map for Complex Lorenz equations, invariant polynomials]{Return map to the \Poincare\
...
appears in the denominator, and thus our invariants are not optimal in the sense that we
...
\end{center}
\caption[Return map for Complex Lorenz equations]{Return map to the \Poincare\

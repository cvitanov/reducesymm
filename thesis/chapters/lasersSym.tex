...
\end{center}
\caption[Orbit space projection of Complex Lorenz system]{ Phase space
portraits of \CLe dynamics for $r_1=28,\, b=8/3,\, \sigma=10,\, a=1$, $e=0.01$, $r_2=0$ 
in orbit space. Projecting on invariants given in \refeq{eq:invLaser2}.
    }
\label{fig:CLEinv}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% We can project the dynamics on orbit space using the invariants \refneq{eq:InvLaser} derived by the moving frame
...
To project dynamics on orbit space use a slight variation of \refneq{eq:invLaser}:
\beq
\begin{split}

...
\CLf\ is equivariant under the action \refneq{eq:RotCLe} of $\SOn{2}$. 
...
In the non-generic case of an \SOn{2}-orbit of \eqva\
it has been shown by Krupa\cite{Krupa_bifurcations_1990} that one gets bifurcation to periodic orbits. \ES{The secondary bifurcation has
been studied in \refref{NingHakenCLE90}.
    The results are messy and hard to comment on.
They show existence of supercritical and subcritical bifurcations. Will continue this discussion
later} Since we are interested in \CLe exactly for the symmetry properties we will concetrate in
the case that results to generic bifurcations. Before we procede with this we briefly examine the
special case $e=r_2=0$.
...
\eqv\ \EQB{0}, a representative of it's unstable manifold(green), 3 repetitions of 
\rpo\ ``01''(magenta) and a generic orbit(blue).}
\label{fig:CLE}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
The first approach we try is by use of invariant polynomials \refneq{eq:ipLaser}, 

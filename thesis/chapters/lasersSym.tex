...
For \CLe\ a trajectory of \refeq{eq:difeqTransv} on the unstable manifold of \REQB{1} is shown
in \reffig{fig:CLEtransv}. Our claim that the trajectory will stay on the cross-section is not
verified by this figure, eventhough this could be atributed to numerical issues.
...
\refeq{eq:difeqTransv}. Shown is a trajectory initiated on the unstable
manifold of $\REQB{1}$  ($r_1=28,\, b=8/3,\, \sigma=10,\, a=1$, $e=1/10$, $r_2=0$).
    }
\label{fig:CLEtransv}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

...
Another decision one has to make is how many modes to retain in \refneq{eq:ksPseudo}. One
...
of our results against increasing the number of modes. \ESedit{For instance,
when we detect an unstable \po\ we check that the period and stability
properties are not altered, within the desired accuracy.}

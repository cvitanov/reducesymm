...
\begin{figure}[t]
\begin{center}
 \includegraphics[width=0.9\textwidth]{../rpo_ks/current/figs/ks_L22_long_orbit.eps}
\end{center}
\caption{
...
\subsection{\Eqva\ and \reqva\ for $L=22$}
...
\begin{figure}[t]
\begin{center}
   (\textit{a})\includegraphics[width=0.35\textwidth]{../rpo_ks/current/figs/1wKS22equil.eps}
 ~~~~(\textit{b})\includegraphics[width=0.35\textwidth]{../rpo_ks/current/figs/2wKS22equil.eps}
 \\
   (\textit{c})\includegraphics[width=0.35\textwidth]{../rpo_ks/current/figs/3wKS22equil.eps}
 ~~~~(\textit{d})\includegraphics[width=0.35\textwidth]{../rpo_ks/current/figs/equilSpatial.eps}
\end{center}
\caption{
...
\begin{figure}[t]
\begin{center}
 \includegraphics[width=4in]{../rpo_ks/current/figs/L22-eqvaEigenvalues.eps}
\end{center}
\caption{
...
\begin{figure}[t]
\begin{center}
 \includegraphics[width=0.3\textwidth]{../rpo_ks/current/figs/ks22_TW1_profile.eps}
 \includegraphics[width=0.3\textwidth]{../rpo_ks/current/figs/ks22_TW2_profile.eps}\\
 \includegraphics[width=0.3\textwidth]{../rpo_ks/current/figs/ks22_TW1_orbit_c.eps}
 \includegraphics[width=0.3\textwidth]{../rpo_ks/current/figs/ks22_TW2_orbit_c.eps}
\end{center}
\caption{
...
\begin{figure}[t]
\begin{center}
 \includegraphics[width=0.5\textwidth]{../rpo_ks/current/figs/ks22_E1_plane1_manifold_c.eps}
 \includegraphics[width=0.4\textwidth]{../rpo_ks/current/figs/ks22_E1_plane1_orbits_c.eps}
\end{center}
\caption{
...
\begin{figure}[t]
\begin{center}
 \includegraphics[width=0.48\textwidth]{../rpo_ks/current/figs/ks22_E1_plane2_manifold_c.eps}
 \includegraphics[width=0.48\textwidth]{../rpo_ks/current/figs/ks22_E1_plane2_orbits_c.eps}
\end{center}
\caption{
The left panel shows the unstable
manifold of \eqv\ \EQV{1} starting within the plane
...
\begin{figure}[ht]
\begin{center}
 \includegraphics[width=0.48\textwidth]{../rpo_ks/current/figs/ks22_E2_manifold_c.eps}
 \includegraphics[width=0.48\textwidth]{../rpo_ks/current/figs/ks22_E2_orbits_c.eps}
\end{center}
\caption{
...
\begin{figure}[t]
\begin{center}
 (\textit{a}) \includegraphics[width=0.4\textwidth]{../rpo_ks/current/figs/ks22manifold1.eps}
 (\textit{b}) \includegraphics[width=0.4\textwidth]{../rpo_ks/current/figs/ks22E2-E3hetero.eps}
\end{center}
\caption{
...
\begin{figure}[t]
\begin{center}
 \includegraphics[width=0.45\textwidth]{../rpo_ks/current/figs/ks22_E3_manifold.eps}
 \includegraphics[width=0.5\textwidth]{../rpo_ks/current/figs/ks22_E3_orbits_c.eps}
\end{center}
\caption{
The left panel shows the two-dimensional
...
connection to $\EQV{2}$ family)  on $\bbUplus$, while the other does not lie on symmetry-invariant subspace.
Similarly, for the $\EQV{1}$ family we observe that the equilibria in $\bbUplus$ have
an unstable plane on $\bbUplus$ (again related to the heteroclinic connection) and a second one with no symmetry.
Thus $\Shift_{1/4}\EQV{2}$ appears as a sink on $\bbUplus$, while all other equilibria appear as sources.
This explains the heteroclinic connections from $\EQV{1}\,,\EQV{2}$ and $\EQV{3}$ to $\Shift_{1/4}\EQV{2}$.
Observing that $\Shift_{1/4} \bbUplus= \bbUone$ and taking into account \reftab{tab:Eksym} we understand that within $\bbUone$
...
\begin{figure}[t]
\begin{center}
         \includegraphics[width=0.6\textwidth]{../rpo_ks/current/figs/KS22hetero.eps}
\end{center}
...
\begin{figure}[t]
\begin{center}
 \includegraphics[width=0.9\textwidth]{../rpo_ks/current/figs/ks_prox_eq_tw.eps}
\end{center}
\caption{\color{blue}
Proximity of a typical chaotic orbit of the \KSe with $L = 22$ to \eqva\ and \reqva.
...
The distances are measured according to \refeq{eq:proxtw}.
     } \label{f:ks_prox_eq}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
the chaotic dynamics is also minimal\ES{After plotting unstable manifold of \REQV{\pm}{1}
in \reffig{fig:SO2inv} I don't anymore agree with this arguement.}.

}%end \PublicPrivate



\subsection{\Rpo s for $L=22$}
\label{sec:rpos}
...
\begin{figure}[t]
\begin{center}
 (\textit{a})\hspace{1ex}\includegraphics[width=0.7\textwidth]{../rpo_ks/current/figs/ks22_rpos_Tdelta.eps}\\
 (\textit{b})\includegraphics[width=0.72\textwidth]{../rpo_ks/current/figs/ks22_rpos_lyap.eps}
\end{center}
\caption{
...
\includegraphics[width=0.15\textwidth]{../rpo_ks/current/figs/ks22rpo016.3-02.86.eps}\hspace{-3ex} &
\includegraphics[width=0.15\textwidth]{../rpo_ks/current/figs/ks22rpo033.5-04.04.eps}\hspace{-3ex} &
\includegraphics[width=0.15\textwidth]{../rpo_ks/current/figs/ks22rpo047.6-05.68.eps}\hspace{-3ex} &
\includegraphics[width=0.15\textwidth]{../rpo_ks/current/figs/ks22rpo071.7-05.50.eps}\hspace{-3ex} &
\includegraphics[width=0.15\textwidth]{../rpo_ks/current/figs/ks22rpo020.5-00.00.eps}\hspace{-3ex} &
\includegraphics[width=0.15\textwidth]{../rpo_ks/current/figs/ks22rpo066.8-00.00.eps}\\
(\textit{b}) & (\textit{d}) & (\textit{f}) &
(\textit{h}) & (\textit{j}) & (\textit{l})\\
\includegraphics[width=0.15\textwidth]{../rpo_ks/current/figs/ks22rpo032.8-10.96.eps}\hspace{-3ex} &
\includegraphics[width=0.15\textwidth]{../rpo_ks/current/figs/ks22rpo034.6-09.60.eps}\hspace{-3ex} &
\includegraphics[width=0.15\textwidth]{../rpo_ks/current/figs/ks22rpo059.9-05.44.eps}\hspace{-3ex} &
\includegraphics[width=0.15\textwidth]{../rpo_ks/current/figs/ks22rpo084.4-05.51.eps}\hspace{-3ex} &
\includegraphics[width=0.15\textwidth]{../rpo_ks/current/figs/ks22rpo064.7-00.00.eps}\hspace{-3ex} &
\includegraphics[width=0.15\textwidth]{../rpo_ks/current/figs/ks22rpo070.3-00.00.eps}
\end{tabular}
\end{center}
...
\begin{center}
 \begin{tabular}{cc}
        ~~~~~~~~(\textit{a})                        &   ~~~~~~~~(\textit{b}) \\
    \includegraphics[width=0.46\textwidth]{../rpo_ks/current/figs/energyBalance_pst.eps}  & \includegraphics[width=0.46\textwidth]{../rpo_ks/current/figs/equivaEP_pst.eps}
...
\begin{center}
 \begin{tabular}{cc}
        ~~~~~~~~(\textit{a})                        &   ~~~~~~~~(\textit{b}) \\
    \includegraphics[width=0.46\textwidth]{../rpo_ks/current/figs/connEP.eps}     & \includegraphics[width=0.46\textwidth]{../rpo_ks/current/figs/connPEdot.eps}
 \end{tabular}
\end{center}
\caption{
...
\begin{figure}[t]
\begin{center}
(\textit{a})\includegraphics[width=0.46\textwidth]{../rpo_ks/current/figs/ks22rpo033.50_04.045E2.eps}
(\textit{b})\includegraphics[width=0.46\textwidth]{../rpo_ks/current/figs/ks22rpo033.50_04.045E2CM.eps}
\\
\end{center}
\caption{
 The

...
lists the symmetries of the \ES{\ESedit{dropped}:stability, after RG suggestion.} eigenvectors of
\eqva\ \EQV{1} to \EQV{3}.
...
part of the leading complex eigenvalue of each \ESedit{
\eqv\ or \reqv},
the expansion
...
\ESedit{suggests} that the `cage' of unstable manifolds of \eqva\ plays
an important role in organizing the chaotic dynamics of the \KS\
equation. \ESedit{Yet they do not tell the whole story. As we will see
in \refchap{chap:kseRedStSp} the unstable manifold of the \reqva\ are
equally important.}

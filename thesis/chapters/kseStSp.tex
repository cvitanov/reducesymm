...
of the relative equilibria and the unstable manifolds of the antisymmetric equilibria that are not restricted in the antisymmetric subspace (and we haven't payed any attention to) will play some role in organizing this mess.}
...
of L=22 \KS\ dynamics on invariants given in \reftab{tab:SO2n6modif}. The trajectories shown are 20 short \rpo s. }
\label{fig:SO2inv}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

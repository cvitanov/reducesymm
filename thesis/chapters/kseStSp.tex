...
\begin{figure}[t]
\begin{center}
 (\textit{a}) \includegraphics[width=0.4\textwidth]{../figs/ks22manifold1}
 (\textit{b}) \includegraphics[width=0.4\textwidth]{../figs/ks22E2-E3hetero}
\end{center}
...
\end{center}
\caption[All \rpo s period, shifts and Lyapunov exponents]{

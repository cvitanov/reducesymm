...
%%%%%%%%%%%%%%% Oxford UP tweaks %%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\listofsections}[1]{} % ChaosBook does not do this
%\newcommand{\thebibliographybychapter}{\begin{thebibliography}}
%\renewcommand{\endthebibliographybychapter}{\end{thebibliography}}
...
%        \renewcommand{\baselinestretch}{1.0}%
%                    }
  \newcommand{\RM}[1]{\marginpar{Ronnie: \footnotesize#1}}

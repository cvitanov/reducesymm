...
\ifboyscout %%%%%%%% DISPLAY COMMENTS IN THE TEXT %%%%%%%%%%%%%%%%%%%%
  ...
  \newcommand{\Kamal}[2]{$\footnotemark\footnotetext{QG #1: #2}$} %date, comment
  \newcommand{\Kamaledit}[1]{{\color{green}#1}}
...
\else % drop comments
  ...
  \newcommand{\Kamal}[2]{}{} %date, comment
  \newcommand{\Kamaledit}[1]{#1}

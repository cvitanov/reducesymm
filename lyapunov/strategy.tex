...
Start with \refsect{sect:intro} which is a work in progress:
an introduction to the Grand Dream of this project.
To read the blog, go first to the latest blog post, end
of \refchap{c-DailyBlog}. For specialized topics, consult the
contents.
Poincar\'e sections are discussed in \refsect{s:PoincSect},
Newton method for flows in \refsect{s-POs-flows}, and
some tentative thoughts on how to thing about co-moving
Floquet vector frames are discussed in
\refsect{sect:stabComoving} (stability in a co-moving frame) and
\refsect{sect:transport} (transport of vector fields).

...
\refappe{s-POs-flows}, and some tentative thoughts on how to thing about
...
A copy is in
\HREF{http://chaosbook.org/library/KoSa11.pdf}{ChaosBook.org/library}.
...
collective work. With Evangelos it is different, considering the state of
world economy and the drag it's inducing on the industrious Greeks.
You might consider including him as the third author, as long as
this is not causing problems for Kazz (the ethics would be the same as when
includes a person who provides data used in a given paper). The
collaboration will surely pay off for you Dresdenites in the long run.

You also have to take in account that he had a misfortune of studying
with me, and I publish on glacial scales, in PRL only to help students
...
noisy cigars) is key ingradient

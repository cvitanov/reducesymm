...
of \refchap{c-#} for \KS\ discussion, and the end 
of \refchap{c-DailyBlog} for general remarks. 

For specialized topics, consult the
contents.
Inner products are discussed in
\refappe{def:innerProduct}
Poincar\'e sections are discussed in \refappe{s:PoincSect},
Newton method for flows in \refappe{s-POs-flows}, and

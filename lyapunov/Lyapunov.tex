...
At least for the KS equation,
 they just mistook the spurious modes (as in \rf{YaTaGiChRa08}) for HLMs
 (because of the sinusoidal structure).
Concerning the dispersion relation, we showed
 in \rf{YaTaGiChRa08} that
 ...
 modes near the physical-spurious threshold (at least for KS),
...
Poincar\'e map of the flow.) The stretching experienced by a fluid
...
This is another interesting and important application of the covariant vectors,
 I think.
...
Because the embedding space has usually larger dimension
 ...
 ``spurious exponents'' corresponding
 to the extra dimension of the embedding space.
There had been no practical method to distinguish true from spurious exponents
 before, until Kantz \textit{et al.} found that the angle between
 a covariant vector and attractor tangent space provides a clear criterion

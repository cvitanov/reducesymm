% siminos/lyapunov/TaCh12/TaCh12.tex             latex TaCh12
% $Author$ $Date$
...
% \usepackage[pdfmark,colorlinks]{hyperref} %% failed to activate hyperlinks
...
\begin{figure}[t]
 \begin{center}
  ...
  limit-cycle oscillators \eref{eq:GLDef}. (a) LEs $\lambda^{(j)}$ and

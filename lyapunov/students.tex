...
\item[2013-02-22 Qi Ge] So sorry for not writing a log. I have just finished the program to calculate the Lyapunov Exponents of KS system. Anyway, the programme running relative slow. I will attach my program in the this subfolder named as lya_exp.cpp. I wish to confirm the result in this paper \refref{SCD07} (page 12).

    Here is my choice of the parameters:
    The cutoff of k is 127 and timestep is 0.001. I plan to run the simulation in 1000 step.(Anyway, I have not added any verification to whether this should be stop there or earlier or later.) The simulation algorithms is 4th-order Runge-Kutta.

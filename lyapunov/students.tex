...
is the same as what we do. For the record, it should be what I have
now entered in your project report \refsect{sect:introQG}, so one can
your compare to \refref{SCD07}. Form of the equation matters, as
Lyapunov exponents are dimensionally 1/[time], and units of time
depend on the form of \KSe.
...
\item[2013-02-19 Predrag]
Regarding \reffig{Lyapunovexpo_gq1}: you cannot live with time step
$h = 0.000001$; the shortest \po\ for $L = 22$ we have in
\refref{SCD07} has period $\period{p} = 16.3$. I do not know what you
did, as you give no indication how long did you run the simulation.
...
``A relatively reasonable Lyapunov spectrum'' compared to what?
...
Read {\bf 2009-09-14 Predrag} above. Always plot  $x$-axis in
$j/\tildeL = 2 \pi j/L$ units, as in \reffig{fig:lyapSpecRscld}.
Plotting it as a function of $j$ is useless.

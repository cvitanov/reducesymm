...
$\phi_k$ the polar angle in the $a_k$ Fourier subspace.
    \PC{2011-12-28 It's too long a story for a comment, but for me any
    invariant basis constructed from Fourier coefficients is good only
    for a neighborhood of $u(x,t) \approx 0$, the most unphysical of
    \eqva. But ignore my problem with this for now - let's see your
    slicing it works
    }
...
Motivating \refeq{eq:SO2polarExt}
    \PC{2011-12-28 was \refeq{eq:O2inv}??}
is still rough around the edges, but the final result is
1) easily seen to be $\On{2}$-invariant,

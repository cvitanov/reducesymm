...
% $\REQV{\pm}{2}$ &\ 0.6048 &  &  & \\
   ...
   $\EQV{2}$ & ?? & 0 &&& 0.4382 & ?? & 1r (+0) & $0.1390$& $0.2384$ \\ % 1606
   $\EQV{3}$ & ?? & 0 &&& 1.5876 & ?? & 1c (+1r+2c) & $0.0933$&         \\ %1 & 0.0224+0.0660i \\
   $\REQV{\pm}{1}$ & ?? & ?? &&& 0.4649 & ?? & 1r (+1r+2c) & $0.1156$ & $0.8173$ \\ %1 & 0.0496 \\
   $\REQV{\pm}{2}$ & ?? & ?? &&& 0.6048 & ?? & 3c (+3c+) & $0.3370$ &         \\ %3 & 0.1517+1.7591i \\
   $\RPO{16.4}$ &  $S$    & 1.302 & 16.4 &&&& 1r+2c & 0.328 \\ %2544
   $\RPO{33.5}$ &  $(S,\Omega_2)$  & 0.12? & 33.5 & 4.04 & ?? & ?? & 1c (+4c+) \\ %244h
   $\RPO{71.7}$ &  $S$    & 0.077? & 71.7 & 5.503 & ?? & ?? & 1r+3c+  \\ %2663
   $\RPO{??}$ &  $S$    & 1.302 & ?? && ?? & ?? & 1r+2c  \\ %2544
   $\RPO{??}$ &  $S$    & 1.302 & ?? && ?? & ?? & 1r+2c     %2544
   \end{tabular}
   %} % end \small
\end{table*}
...
significant digits of its period $\period{}$.
    \PC{2011-12-20 Change symmetries in \reftab{tab:RPOs} following
    \refref{SCD07}. Either merge \reftab{tab:L22cminus} into

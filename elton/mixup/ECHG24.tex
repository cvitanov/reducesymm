...
\bea
  ...
  \bold{x}_{_{SP_{7}}} &=& (L_x/4,0,L_z/2) \label{s4lagrange} \\ %% PC was {s3lagrange}
...
\bibliographystyle{plain} %{jfm} %% PC 2024-12-20 was {unsrt} %prsty} %apsrev} %plain}
    \ifsubmission
\section*{References}

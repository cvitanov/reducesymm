...
\textcolor{red}{Although computationally feasible, the Newton--GMRES iterations are still
...
demanding a very good initial guess for the iterations to converge~\citep{W97}. \textcolor{red}{The Newton
...
to revisit the methods by which these invariant solutions are found. 
 \textcolor{red}{Better methods should ideally scale linearly (in the sense of computational complexity) 
...
\textcolor{red}{Adjoint equations appear naturally in optimal control, where the governing equations
...
\textcolor{red}{To the best of our knowledge, adjoint-based methods have not been used to 
...
\textcolor{red}{Anecdotal evidence suggests that, in the context of fluid flow,
...
of a better term, we refer to this regime as the \emph{ergodic sea} \textcolor{red}{(Here, the term `ergodic' is not meant in
...
%\includegraphics[width=.9\textwidth]{R40_distFromEQ_03}
%\caption{Upper panel: The $L^2$ distance $\|\mathcal P\omega(t)-\mathcal PE\|_{L^2}$
%between the symmetric part of the turbulent trajectory $\mathcal{P}\omega$
%and the symmetric parts of the equilibria $E_{13}$ (red), 
%$E_{11}$ (blue) and $E_{1}$ (green).
...
\textcolor{red}{For instance, the evolution of the distance from $E_{11}$ is also

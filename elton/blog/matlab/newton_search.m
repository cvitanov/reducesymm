keep v_grid
global uu ug Mx My Mz Nx Ny Nz Nd Lx Lz a b lx lz alpha gamma N uspec1 uspec2 uspec3 u A
...
r = [2.33476062218540; 0.409523809523809523; 0.64577182323790];  % initial guess
rfix = [Lx/2; 0; Lz/4];
r1 = 2*rfix - r;

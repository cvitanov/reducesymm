...
% {\bf Special Problem, summer semester 2004}
 ...
 \beq
  \dot{a}_k=(k/\tildeL)^2\left(1-(k/\tildeL)^2 k^2\right)a_k
 ...
 \bea
  \dot{b}_k & = & \left(\frac{k}{\tildeL}\right)^2\left(1- \left(k/\tildeL\right)\nu k^2\right)b_k  \continue
 ...
 \eea
 \bea
   \dot{c}_k & = & \left(\frac{k}{\tildeL}\right)^2\left(1- \left(2\pi/L\right)\nu k^2\right)c_k  \continue
...
respect to $a_k(t+T)$. In matrix notation, we write \refeq{eq:RPOcondition} as
\beq
	R(\kappa)a(t+T)=a(t)\,,
	\label{eq:RPO}
\eeq
...
Taylor expanding \refeq{eq:cond Rf(a)} around $a'$ we get
\bea

...
% {\bf Special Problem, summer semester 2004}
 ...
 is a constant. Furthermore $a_0$ does not appear in the equations for $k \neq 0$. Thus, we may set $a_0=0$ without loss of generality and we only have to compute $a_k$'s with $k\geq 1$.

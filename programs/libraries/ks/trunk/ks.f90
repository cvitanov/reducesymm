...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
SUBROUTINE ksFJ_equil_elim(bc,elim,fvec,fjac)
USE nrtype
use nrutil, only:assert_eq
...
ndum=assert_eq(d,size(bc),size(fvec)+1,'ksFJ_equil_1')
ndum=assert_eq(ndum,size(fjac,1)+1,size(fjac,2)+1,'ksFJ_equil_2')
...
fvec(1:d/2-1)=real(fvec_c(2:size(fvec_c)))
fvec(d/2:d-1)=aimag(fvec_c)
...
fjac(1:d/2-1,1:d/2-1)=jbb(2:d/2,2:d/2)	! Eliminate b_1 variable
fjac(1:d/2-1,d/2:d-1)=jbc(2:d/2,1:d/2)
fjac(d/2:d-1,1:d/2-1)=jcb(1:d/2,2:d/2)
fjac(d/2:d-1,d/2:d-1)=jcc

END SUBROUTINE ksFJ_equil_elim

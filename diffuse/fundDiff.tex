...
There is one last piece before we apply \refeq{eq-fd-msd} to
...
~\reffig{fig-twodisk}. Boundary cycles remain unchanged when we apply
the group action that reflects about the symmetry line, thus
simultaneously contribute to multiple terms in
\refeq{eq-trace-ir-expan} (Remember, we absorbed the group element
...
of~\refref{DasBuch}), in our system the boundary oribts contribute

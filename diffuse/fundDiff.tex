...
\,,
\eeq
is the weight associated with the orbit. Eq.~\refeq{eq-fd-zeta} takes a
...
\refeq{eq-det-disc}. Generalization to continuous flow is also different.
...
comes an interesting discovery (to which we return in \refsect{##}):

...
In previous works~\rf{CGS92, DasBuch} fundamental domain cycle 
expansion for scalar quantities such like Lyapunov constant was 
obtained. However, for reasons mentioned in \refsect{s-FundTranslation}, 
...
It follows that the integral in \refeq{eq-trace-ir-disc} is written as
...
the form already computed in~\refeq{eq-fdDisplacement}.  The Jacobian
${\bf J}(\tx)$ 
...
fundamental domain $r$ times. Formula \refeq{eq-msd} is an infinite

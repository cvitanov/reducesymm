...
multiple terms in \refeq{eq-trace-ir-expan} (Remember, we absorbed 
...
chapter 9 of~\refref{DasBuch}), in our system the boundary oribts 
contribute normally and does not need special treatment (see 
formulations in chapter 25 of ~\refref{DasBuch}).

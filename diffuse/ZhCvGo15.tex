...
flows\rf{solomon1994chaotic} which can be described as
...
transport of ions across the cell membranes\rf{stein2012transport}
and the movement of microorganism (e.g. bacterials) through natural
ecosystems\rf{koch1990diffusion}. In this paper we will discuss the
transport property of more "macroscopic" systems (such as moving
robots\rf{saranli2001rhex}) where a ``diffusive description'' also
applies.
...
understanding\rf{li2009sensitive,li2013terradynamics}. However,
...
Lorentz gas model\rf{Dettm14} for locomotion in a boulder field.
...
In \refrefs{art91,LorentzDiff,CGS92,Artuso94} it was shown that
...
\reffig{fig-schrieberFig1}. The dynamics restricted inside the elementary

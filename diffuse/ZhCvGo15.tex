...
We now turn to the connection between \refeq{lor-diff-1} and periodic orbits in
...
starting from a disk, see \reffig{fig-diskDirectionsElCell}\,(a). A periodic
...
\includegraphics[width=0.45\textwidth]{diffuseDiffCoefPlot}
  ...
  Green-Kubol numerical experiments\rf{Zwanzig1983}; stars\rf{Cohen1993} and
  circles\rf{Gaspard1995} are calculated from escape rate; and triangles are
  given by Hausdorff fractal dimension calculation\rf{Gaspard1995}; dashed line

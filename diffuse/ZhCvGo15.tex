...
%    \PC{2015-10-17}{cite
%Cvitanovi\'c, Eckmann and Gaspard\rf{LorentzDiff},
%Artuso\rf{art91,Artuso94}
%    }

In \refref{CGS92} it was shown that the {\em periodic} Lorentz gas is
...
orbits in the elementary cell. It was shown in \refref{CGS92} that the
ensemble average in \refeq{lor-diff-1} can be written as an integral over
the elementary cell
\beq
...
\reffig{fig-diskDirectionsElCell}\,(a). A periodic orbit then can always

...
\end{equation}
the ``weight'' associated to the orbit. Equation \refeq{eq-fdZeta} differs from  XX but can be casted back, if the symmetry group contains only $e$.

...
\label{fig:7diskFundDflips} }

\end{figure}
\begin{figure}[htbp]
\includegraphics[width=0.45\textwidth]{fdSymbolIllustration}
\caption{topologically distinct flights, with imposed finite horizon.\label{fig:fdflights}}
\end{figure}
...
G-equivariance of the displacement in the full space.
...
Results for $w$=0.3.
(left) Schreiber 1992 calculation\rf{CGS92} (and Zhang 2014) in EC. (right) Zhang 2014 calculation in FD. Gaspard 1992 note: ``My numerical estimate for the Lyapunov exponent
...
\caption[]{Diffusion coefficients as a function of inter-disk separation distance $w$.\label{fig:results}}
\end{figure}

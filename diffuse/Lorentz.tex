...
Consider \reffig{fig-LorentzGasParams}, with $w$ the distance between the
...
\beq
\frac{w}{r} < \frac{4}{\sqrt{3}}-2 =0.3094\cdots
\,,
\ee{FinInfHoriz}
...
\begin{figure}[htbp]
    ...
    ratio \refeq{FinInfHoriz} of the distance between the nearest pair

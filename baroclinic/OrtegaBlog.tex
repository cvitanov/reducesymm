...
\frac{\partial}{\partial \gSpace}
    (\ssp-\LieEl\slicep)^\dagger (\ssp-\LieEl\slicep)
&=& -\frac{\partial}{\partial \gSpace}
(\slicep^\dagger\LieEl^\dagger\ssp {\color{red}+} \ssp^\dagger\LieEl\slicep) %DB edit in red
...
Substitute $\ssp=\LieEl\sspRed$.
    ...
    have to redo it more carefully for nonabelian groups. DB: Don't understand this... $\LieEl \Lg = \LieEl \Lg$ is always true,no?}

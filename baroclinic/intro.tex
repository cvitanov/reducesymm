...
already been discussed in \refsect{s:examples}. In \refsect{s:qg} we
...
the case were a two layer model is considered.  \refSect{s:stability}
...
equation\rf{Salmon98}:
    ...
    how to put the together, have a singel citation to them, in this case
    \refeq{eq:TWE}}
\bea

...
solution to another; see for instance \refref{GHCV08}), are commonly studied for this purposes as these organize
...
\beq
    \Re(\sspRed^\dagger \Lg \slicep)=Re\left(\frac{-2 \pi i}{N} \sum_{k=0}^{N-1} \sum_{k=0}^{M-1} \overline{u_{lk}} u'_{lk} k e^{\frac{-2 \pi i k}{N} \gSpace}\right)=0
\ee{min4} 

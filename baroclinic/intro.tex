...
allow us to extract important knowledge about this phenomena.
        \SOA{I think I will remove this section. I have to modify the
        introduction for this. But it does not seem natural to talk about
        this here.}
...
This quantity arises naturally from Navier-Stokes equations, and is just
...
obtained from equation \refeq{NS1} the desired expression for the
vorticity (see \refref{Salmon98} for further detail):
\beq
...
\refsect{s:examples}): the nearly geostrophic motions and the wind vertical
...
\refrefs{Vallis06,Holton79,Salmon98}.
